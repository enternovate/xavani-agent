...
Both publish at:
  https://xavani-agent.nousresearch.com/docs/llms.txt
  https://xavani-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://xavani-agent.nousresearch.com/docs"
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://xavani-agent.nousresearch.com/docs\n",
        "Short index: https://xavani-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
