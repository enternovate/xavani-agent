...
"""Generate llms.txt and llms-full.txt for the Xavani docs site.
...
Both publish at:
  https://enternovate.co.za/xavani-agent/docs/llms.txt
  https://enternovate.co.za/xavani-agent/docs/llms-full.txt
...
SITE_BASE = "https://enternovate.co.za/xavani-agent/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Xavani as a Python Library", None),
        ("guides/use-mcp-with-xavani", "Use MCP with Xavani", None),
        ("guides/use-voice-mode-with-xavani", "Use Voice Mode with Xavani", None),
        ("guides/use-soul-with-xavani", "Use SOUL.md with Xavani", None),
        ("guides/build-a-xavani-plugin", "Build a Xavani Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Xavani"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Xavani Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Enternovate. A terminal-native "
        ...
        "backends. Works with Xavani Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/enternovate/"
        "xavani-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/enternovate/xavani-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Xavani Agent — Full Documentation\n",
        (
            "This file is the entire Xavani Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Xavani, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://enternovate.co.za/xavani-agent/docs\n",
        "Short index: https://enternovate.co.za/xavani-agent/docs/llms.txt\n",
        "\n---\n\n",
    ]
