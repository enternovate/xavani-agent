    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/enternovate/xavani-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/enternovate/xavani-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/enternovate',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/xavani' },
            { label: 'GitHub Discussions', href: 'https://github.com/enternovate/xavani-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/enternovate/xavani-agent' },
            { label: 'Enternovate', href: 'https://enternovate.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://enternovate.com">Enternovate</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
