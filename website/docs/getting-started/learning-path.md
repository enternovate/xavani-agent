...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Xavani Agent documentation based on your experience level and goals.'
---
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Xavani Agent can do.
...
:::tip
Pass files directly into your conversation with context files. Xavani Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Xavani Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Xavani](/docs/guides/use-voice-mode-with-xavani)
...
:::tip
Cron jobs let Xavani Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Xavani Agent with your own tools and reusable skill packages.

1. [Plugins](/docs/user-guide/features/plugins)
2. [Build a Xavani Plugin](/docs/guides/build-a-xavani-plugin)
...
page is for built-in Xavani core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Xavani Agent's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how Xavani Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Xavani Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Xavani tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |
