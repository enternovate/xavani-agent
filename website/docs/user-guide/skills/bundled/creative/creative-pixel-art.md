...
```python
import sys
sys.path.insert(0, "/home/teknium/.xavani/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.xavani/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Xavani installs package this)
