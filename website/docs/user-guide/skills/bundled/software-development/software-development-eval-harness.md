---
title: "Eval Harness — Define, run, and report evaluation cases"
sidebar_label: "Eval Harness"
description: "Define, run, and report evaluation cases"
---
...
Define, run, and report evaluation cases. Build the eval first — define what success looks like before writing code. Use before and after changes to verify behaviour.
...
| Path | `skills/software-development/eval-harness` |
| Platforms | all |
