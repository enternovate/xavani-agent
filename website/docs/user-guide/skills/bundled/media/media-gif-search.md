...
Set your Tenor API key in your environment (add to `~/.xavani/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/enternovate/xavani-agent/blob/main/skills/media/gif-search/url)`
