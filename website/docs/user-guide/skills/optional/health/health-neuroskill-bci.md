...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/health/neuroskill-bci` |
...
Connect Xavani to a running [NeuroSkill](https://neuroskill.com/) instance to read
