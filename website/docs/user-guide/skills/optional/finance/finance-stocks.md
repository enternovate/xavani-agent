...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Xavani Agent |
| License | MIT |
...
```
SCRIPT=~/.xavani/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.xavani/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
