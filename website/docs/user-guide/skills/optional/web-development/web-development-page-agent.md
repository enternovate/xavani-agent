...
- User wants **Xavani itself to drive a browser** → use Xavani' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
