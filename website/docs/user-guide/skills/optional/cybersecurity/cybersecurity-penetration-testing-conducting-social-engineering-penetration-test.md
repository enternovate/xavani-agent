...
sidebar_label: "Conducting Social Engineering Penetration Test"
description: "Design and execute a social engineering penetration test including phishing, vishing, smishing, and physical pretexting campaigns to measure human security r..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-social-engineering-penetration-test` |
| Path | `optional-skills/cybersecurity/penetration-testing/conducting-social-engineering-penetration-test` |
| Platforms | all |
