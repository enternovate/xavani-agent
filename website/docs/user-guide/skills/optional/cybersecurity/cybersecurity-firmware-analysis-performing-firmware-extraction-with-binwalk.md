...
sidebar_label: "Performing Firmware Extraction With Binwalk"
description: "Performs firmware image extraction and analysis using binwalk to identify embedded filesystems, compressed archives, bootloaders, kernel images, and cryptogr..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-firmware-extraction-with-binwalk` |
| Path | `optional-skills/cybersecurity/firmware-analysis/performing-firmware-extraction-with-binwalk` |
| Platforms | all |
