...
sidebar_label: "Implementing Container Image Minimal Base With Distroless"
description: "Reduce container attack surface by building application images on Google distroless base images that contain only the application runtime with no shell, pack..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-container-image-minimal-base-with-distroless` |
| Path | `optional-skills/cybersecurity/container-security/implementing-container-image-minimal-base-with-distroless` |
| Platforms | all |
