...
sidebar_label: "Hardening Linux Endpoint With Cis Benchmark"
description: "Hardens Linux endpoints using CIS Benchmark recommendations for Ubuntu, RHEL, and CentOS to reduce attack surface, enforce security baselines, and meet compl..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hardening-linux-endpoint-with-cis-benchmark` |
| Path | `optional-skills/cybersecurity/endpoint-security/hardening-linux-endpoint-with-cis-benchmark` |
| Platforms | all |
