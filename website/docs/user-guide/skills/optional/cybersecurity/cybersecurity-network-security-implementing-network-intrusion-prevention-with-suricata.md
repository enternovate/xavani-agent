...
sidebar_label: "Implementing Network Intrusion Prevention With Suricata"
description: "Deploy and configure Suricata as a network intrusion prevention system with custom rules, Emerging Threats rulesets, and inline traffic inspection for real-t..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-network-intrusion-prevention-with-suricata` |
| Path | `optional-skills/cybersecurity/network-security/implementing-network-intrusion-prevention-with-suricata` |
| Platforms | all |
