...
sidebar_label: "Detecting Evasion Techniques In Endpoint Logs"
description: "Detects defense evasion techniques used by adversaries in endpoint logs including log tampering, timestomping, process injection, and security tool disabling"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-evasion-techniques-in-endpoint-logs` |
| Path | `optional-skills/cybersecurity/endpoint-security/detecting-evasion-techniques-in-endpoint-logs` |
| Platforms | all |
