...
description: "Hunt for malicious PowerShell activity by analyzing Script Block Logging (Event 4104), Module Logging (Event 4103), and process creation events"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-anomalous-powershell-execution` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-anomalous-powershell-execution` |
| Platforms | all |
