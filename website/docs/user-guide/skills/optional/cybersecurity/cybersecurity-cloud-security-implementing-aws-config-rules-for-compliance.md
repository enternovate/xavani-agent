...
sidebar_label: "Implementing Aws Config Rules For Compliance"
description: "Implementing AWS Config rules for continuous compliance monitoring of AWS resources, deploying managed and custom rules aligned to CIS and PCI DSS frameworks..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-aws-config-rules-for-compliance` |
| Path | `optional-skills/cybersecurity/cloud-security/implementing-aws-config-rules-for-compliance` |
| Platforms | all |
