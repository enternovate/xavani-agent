---
title: "Deploying Software Defined Perimeter — Deploy a Software-Defined Perimeter using the CSA v2"
sidebar_label: "Deploying Software Defined Perimeter"
description: "Deploy a Software-Defined Perimeter using the CSA v2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/deploying-software-defined-perimeter` |
| Path | `optional-skills/cybersecurity/zero-trust-architecture/deploying-software-defined-perimeter` |
| Platforms | all |
