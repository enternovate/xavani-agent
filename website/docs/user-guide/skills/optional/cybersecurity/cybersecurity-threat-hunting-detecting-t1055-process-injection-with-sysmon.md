...
sidebar_label: "Detecting T1055 Process Injection With Sysmon"
description: "Detect process injection techniques (T1055) including classic DLL injection, process hollowing, and APC injection by analyzing Sysmon events for cross-proces..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-t1055-process-injection-with-sysmon` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-t1055-process-injection-with-sysmon` |
| Platforms | all |
