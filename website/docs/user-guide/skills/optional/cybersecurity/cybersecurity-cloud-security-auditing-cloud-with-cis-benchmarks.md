...
sidebar_label: "Auditing Cloud With Cis Benchmarks"
description: "This skill details how to conduct cloud security audits using Center for Internet Security benchmarks for AWS, Azure, and GCP"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-cloud-with-cis-benchmarks` |
| Path | `optional-skills/cybersecurity/cloud-security/auditing-cloud-with-cis-benchmarks` |
| Platforms | all |
