...
sidebar_label: "Implementing Ot Network Traffic Analysis With Nozomi"
description: "Deploy Nozomi Networks Guardian sensors for passive OT network traffic analysis to achieve comprehensive asset visibility, real-time threat detection, and vu..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-ot-network-traffic-analysis-with-nozomi` |
| Path | `optional-skills/cybersecurity/ot-ics-security/implementing-ot-network-traffic-analysis-with-nozomi` |
| Platforms | all |
