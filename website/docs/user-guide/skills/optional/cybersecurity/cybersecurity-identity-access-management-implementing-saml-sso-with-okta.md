---
title: "Implementing Saml Sso With Okta — Implement SAML 2"
sidebar_label: "Implementing Saml Sso With Okta"
description: "Implement SAML 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-saml-sso-with-okta` |
| Path | `optional-skills/cybersecurity/identity-access-management/implementing-saml-sso-with-okta` |
| Platforms | all |
