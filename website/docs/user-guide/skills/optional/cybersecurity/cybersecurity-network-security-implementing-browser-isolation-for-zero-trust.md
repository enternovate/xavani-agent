...
sidebar_label: "Implementing Browser Isolation For Zero Trust"
description: "Deploys remote browser isolation (RBI) as a core component of a Zero Trust architecture"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-browser-isolation-for-zero-trust` |
| Path | `optional-skills/cybersecurity/network-security/implementing-browser-isolation-for-zero-trust` |
| Platforms | all |
