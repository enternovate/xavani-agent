...
sidebar_label: "Detecting T1003 Credential Dumping With Edr"
description: "Detect OS credential dumping techniques targeting LSASS memory, SAM database, NTDS"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-t1003-credential-dumping-with-edr` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-t1003-credential-dumping-with-edr` |
| Platforms | all |
