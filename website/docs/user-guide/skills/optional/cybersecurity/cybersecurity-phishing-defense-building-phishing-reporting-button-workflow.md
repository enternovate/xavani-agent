...
sidebar_label: "Building Phishing Reporting Button Workflow"
description: "Implement a phishing report button in email clients with automated triage workflow that analyzes user-reported suspicious emails and provides feedback to rep..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-phishing-reporting-button-workflow` |
| Path | `optional-skills/cybersecurity/phishing-defense/building-phishing-reporting-button-workflow` |
| Platforms | all |
