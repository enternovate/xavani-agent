...
sidebar_label: "Performing Thick Client Application Penetration Test"
description: "Conduct a thick client application penetration test to identify insecure local storage, hardcoded credentials, DLL hijacking, memory manipulation, and insecu..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-thick-client-application-penetration-test` |
| Path | `optional-skills/cybersecurity/penetration-testing/performing-thick-client-application-penetration-test` |
| Platforms | all |
