...
sidebar_label: "Detecting T1548 Abuse Elevation Control Mechanism"
description: "Detect abuse of elevation control mechanisms including UAC bypass, sudo exploitation, and setuid/setgid manipulation by monitoring registry modifications, pr..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-t1548-abuse-elevation-control-mechanism` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-t1548-abuse-elevation-control-mechanism` |
| Platforms | all |
