...
sidebar_label: "Testing For Sensitive Data Exposure"
description: "Identifying sensitive data exposure vulnerabilities including API key leakage, PII in responses, insecure storage, and unprotected data transmission during s..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-for-sensitive-data-exposure` |
| Path | `optional-skills/cybersecurity/web-application-security/testing-for-sensitive-data-exposure` |
| Platforms | all |
