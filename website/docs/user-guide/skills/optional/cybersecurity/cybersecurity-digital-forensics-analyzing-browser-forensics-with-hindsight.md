...
sidebar_label: "Analyzing Browser Forensics With Hindsight"
description: "Analyze Chromium-based browser artifacts using Hindsight to extract browsing history, downloads, cookies, cached content, autofill data, saved passwords, and..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-browser-forensics-with-hindsight` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-browser-forensics-with-hindsight` |
| Platforms | all |
