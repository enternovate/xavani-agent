...
description: "Parse Apache and Nginx access logs to detect SQL injection attempts, local file inclusion, directory traversal, web scanner fingerprints, and brute-force pat..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-web-server-logs-for-intrusion` |
| Path | `optional-skills/cybersecurity/security-operations/analyzing-web-server-logs-for-intrusion` |
| Platforms | all |
