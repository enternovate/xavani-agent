...
description: "Detect PowerShell Empire framework artifacts in Windows event logs by identifying Base64 encoded launcher patterns, default user agents, staging URL structur..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-powershell-empire-artifacts` |
| Path | `optional-skills/cybersecurity/threat-hunting/analyzing-powershell-empire-artifacts` |
| Platforms | all |
