...
sidebar_label: "Configuring Windows Event Logging For Detection"
description: "Configures Windows Event Logging with advanced audit policies to generate high-fidelity security events for threat detection and forensic investigation"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/configuring-windows-event-logging-for-detection` |
| Path | `optional-skills/cybersecurity/endpoint-security/configuring-windows-event-logging-for-detection` |
| Platforms | all |
