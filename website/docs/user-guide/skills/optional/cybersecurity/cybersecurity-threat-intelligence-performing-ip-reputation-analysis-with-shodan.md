...
sidebar_label: "Performing Ip Reputation Analysis With Shodan"
description: "Analyze IP address reputation using the Shodan API to identify open ports, running services, known vulnerabilities, and hosting context for threat intelligen..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-ip-reputation-analysis-with-shodan` |
| Path | `optional-skills/cybersecurity/threat-intelligence/performing-ip-reputation-analysis-with-shodan` |
| Platforms | all |
