...
sidebar_label: "Implementing Gdpr Data Protection Controls"
description: "The General Data Protection Regulation (EU) 2016/679 (GDPR) is the EU's comprehensive data protection law governing the collection, processing, storage, and ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-gdpr-data-protection-controls` |
| Path | `optional-skills/cybersecurity/compliance-governance/implementing-gdpr-data-protection-controls` |
| Platforms | all |
