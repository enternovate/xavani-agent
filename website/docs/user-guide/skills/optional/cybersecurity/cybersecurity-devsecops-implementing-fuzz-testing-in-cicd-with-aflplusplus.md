...
sidebar_label: "Implementing Fuzz Testing In Cicd With Aflplusplus"
description: "Integrate AFL++ coverage-guided fuzz testing into CI/CD pipelines to discover memory corruption, input handling, and logic vulnerabilities in C/C++ and compi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-fuzz-testing-in-cicd-with-aflplusplus` |
| Path | `optional-skills/cybersecurity/devsecops/implementing-fuzz-testing-in-cicd-with-aflplusplus` |
| Platforms | all |
