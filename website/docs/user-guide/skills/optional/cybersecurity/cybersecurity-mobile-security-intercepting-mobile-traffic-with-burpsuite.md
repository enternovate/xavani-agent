...
sidebar_label: "Intercepting Mobile Traffic With Burpsuite"
description: "Intercepts and analyzes HTTP/HTTPS traffic from mobile applications using Burp Suite proxy to identify insecure API communications, authentication flaws, dat..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/intercepting-mobile-traffic-with-burpsuite` |
| Path | `optional-skills/cybersecurity/mobile-security/intercepting-mobile-traffic-with-burpsuite` |
| Platforms | all |
