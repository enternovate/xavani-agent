...
sidebar_label: "Building Attack Pattern Library From Cti Reports"
description: "Extract and catalog attack patterns from cyber threat intelligence reports into a structured STIX-based library mapped to MITRE ATT&CK for detection engineer..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-attack-pattern-library-from-cti-reports` |
| Path | `optional-skills/cybersecurity/threat-intelligence/building-attack-pattern-library-from-cti-reports` |
| Platforms | all |
