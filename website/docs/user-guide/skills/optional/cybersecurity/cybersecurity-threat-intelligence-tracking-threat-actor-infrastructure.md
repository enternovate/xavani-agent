...
sidebar_label: "Tracking Threat Actor Infrastructure"
description: "Threat actor infrastructure tracking involves monitoring and mapping adversary-controlled assets including command-and-control (C2) servers, phishing domains..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/tracking-threat-actor-infrastructure` |
| Path | `optional-skills/cybersecurity/threat-intelligence/tracking-threat-actor-infrastructure` |
| Platforms | all |
