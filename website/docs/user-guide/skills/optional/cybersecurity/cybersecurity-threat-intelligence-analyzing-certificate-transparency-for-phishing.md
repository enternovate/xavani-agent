---
title: "Analyzing Certificate Transparency For Phishing — Monitor Certificate Transparency logs using crt"
sidebar_label: "Analyzing Certificate Transparency For Phishing"
description: "Monitor Certificate Transparency logs using crt"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-certificate-transparency-for-phishing` |
| Path | `optional-skills/cybersecurity/threat-intelligence/analyzing-certificate-transparency-for-phishing` |
| Platforms | all |
...
"""
    for cert in suspicious_certs[:20]:
        ...
        report += (f"| {cert['common_name']} | {cert['issuer'][:30]} "
                   f"| {flags} | [View](https://github.com/enternovate/xavani-agent/blob/main/optional-skills/cybersecurity/threat-intelligence/analyzing-certificate-transparency-for-phishing/{cert['crt_sh_url']}) |\n")
