...
sidebar_label: "Implementing Aqua Security For Container Scanning"
description: "Deploy Aqua Security's Trivy scanner to detect vulnerabilities, misconfigurations, secrets, and license issues in container images across CI/CD pipelines and..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-aqua-security-for-container-scanning` |
| Path | `optional-skills/cybersecurity/devsecops/implementing-aqua-security-for-container-scanning` |
| Platforms | all |
