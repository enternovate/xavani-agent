...
sidebar_label: "Detecting Oauth Token Theft"
description: "Detects and responds to OAuth token theft and replay attacks in cloud environments, focusing on Microsoft Entra ID (Azure AD) token protection, conditional a..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-oauth-token-theft` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-oauth-token-theft` |
| Platforms | all |
