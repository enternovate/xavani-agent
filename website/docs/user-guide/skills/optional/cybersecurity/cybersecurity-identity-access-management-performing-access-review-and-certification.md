...
sidebar_label: "Performing Access Review And Certification"
description: "Conduct systematic access reviews and certifications to ensure users have appropriate access rights aligned with their roles"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-access-review-and-certification` |
| Path | `optional-skills/cybersecurity/identity-access-management/performing-access-review-and-certification` |
| Platforms | all |
