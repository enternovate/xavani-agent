...
description: "Implements cloud workload protection using boto3 and google-cloud APIs for runtime security monitoring, process anomaly detection, and file integrity checkin..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-cloud-workload-protection` |
| Path | `optional-skills/cybersecurity/cloud-security/implementing-cloud-workload-protection` |
| Platforms | all |
