...
sidebar_label: "Building Detection Rule With Splunk Spl"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-detection-rule-with-splunk-spl` |
| Path | `optional-skills/cybersecurity/soc-operations/building-detection-rule-with-splunk-spl` |
| Platforms | all |
