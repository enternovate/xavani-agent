...
sidebar_label: "Building Detection Rules With Sigma"
description: "Builds vendor-agnostic detection rules using the Sigma rule format for threat detection across SIEM platforms including Splunk, Elastic, and Microsoft Sentinel"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-detection-rules-with-sigma` |
| Path | `optional-skills/cybersecurity/soc-operations/building-detection-rules-with-sigma` |
| Platforms | all |
