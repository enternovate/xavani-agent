...
sidebar_label: "Analyzing Uefi Bootkit Persistence"
description: "Analyzes UEFI bootkit persistence mechanisms including firmware implants in SPI flash, EFI System Partition (ESP) modifications, Secure Boot bypass technique..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-uefi-bootkit-persistence` |
| Path | `optional-skills/cybersecurity/firmware-security/analyzing-uefi-bootkit-persistence` |
| Platforms | all |
