...
sidebar_label: "Performing Android App Static Analysis With Mobsf"
description: "Performs automated static analysis of Android applications using Mobile Security Framework (MobSF) to identify hardcoded secrets, insecure permissions, vulne..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-android-app-static-analysis-with-mobsf` |
| Path | `optional-skills/cybersecurity/mobile-security/performing-android-app-static-analysis-with-mobsf` |
| Platforms | all |
