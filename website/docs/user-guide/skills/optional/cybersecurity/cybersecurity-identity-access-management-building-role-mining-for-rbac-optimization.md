...
sidebar_label: "Building Role Mining For Rbac Optimization"
description: "Apply bottom-up and top-down role mining techniques to discover optimal RBAC roles from existing user-permission assignments, reducing role explosion and enf..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-role-mining-for-rbac-optimization` |
| Path | `optional-skills/cybersecurity/identity-access-management/building-role-mining-for-rbac-optimization` |
| Platforms | all |
