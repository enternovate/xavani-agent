...
description: "Implements security chaos engineering experiments that deliberately disable or degrade security controls to verify detection and response capabilities"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-security-chaos-engineering` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-security-chaos-engineering` |
| Platforms | all |
