...
sidebar_label: "Triaging Security Incident"
description: "Performs initial triage of security incidents to determine severity, scope, and required response actions using the NIST SP 800-61r3 and SANS PICERL frameworks"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/triaging-security-incident` |
| Path | `optional-skills/cybersecurity/incident-response/triaging-security-incident` |
| Platforms | all |
