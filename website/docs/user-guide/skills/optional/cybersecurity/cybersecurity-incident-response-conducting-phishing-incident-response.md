...
sidebar_label: "Conducting Phishing Incident Response"
description: "Responds to phishing incidents by analyzing reported emails, extracting indicators, assessing credential compromise, quarantining malicious messages across t..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-phishing-incident-response` |
| Path | `optional-skills/cybersecurity/incident-response/conducting-phishing-incident-response` |
| Platforms | all |
