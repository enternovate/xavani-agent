...
sidebar_label: "Implementing Canary Tokens For Network Intrusion"
description: "Deploys DNS, HTTP, and AWS API key canary tokens across network infrastructure to detect unauthorized access and lateral movement"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-canary-tokens-for-network-intrusion` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-canary-tokens-for-network-intrusion` |
| Platforms | all |
