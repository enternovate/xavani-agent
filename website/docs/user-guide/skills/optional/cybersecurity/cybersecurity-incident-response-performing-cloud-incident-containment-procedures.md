...
sidebar_label: "Performing Cloud Incident Containment Procedures"
description: "Execute cloud-native incident containment across AWS, Azure, and GCP by isolating compromised resources, revoking credentials, preserving forensic evidence, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-incident-containment-procedures` |
| Path | `optional-skills/cybersecurity/incident-response/performing-cloud-incident-containment-procedures` |
| Platforms | all |
