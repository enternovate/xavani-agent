...
sidebar_label: "Analyzing Active Directory Acl Abuse"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-active-directory-acl-abuse` |
| Path | `optional-skills/cybersecurity/identity-security/analyzing-active-directory-acl-abuse` |
| Platforms | all |
