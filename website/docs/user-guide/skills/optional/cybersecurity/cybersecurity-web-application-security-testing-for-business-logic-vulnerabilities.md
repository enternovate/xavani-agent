...
sidebar_label: "Testing For Business Logic Vulnerabilities"
description: "Identifying flaws in application business logic that allow price manipulation, workflow bypass, and privilege escalation beyond what technical vulnerability ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-for-business-logic-vulnerabilities` |
| Path | `optional-skills/cybersecurity/web-application-security/testing-for-business-logic-vulnerabilities` |
| Platforms | all |
