...
sidebar_label: "Performing Graphql Introspection Attack"
description: "Performs GraphQL introspection attacks to extract the full API schema including types, queries, mutations, subscriptions, and field definitions from GraphQL ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-graphql-introspection-attack` |
| Path | `optional-skills/cybersecurity/api-security/performing-graphql-introspection-attack` |
| Platforms | all |
