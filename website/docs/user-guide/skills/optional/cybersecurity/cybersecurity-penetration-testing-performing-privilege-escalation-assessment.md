...
sidebar_label: "Performing Privilege Escalation Assessment"
description: "Performs privilege escalation assessments on compromised Linux and Windows systems to identify paths from low-privilege access to root or SYSTEM-level control"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-privilege-escalation-assessment` |
| Path | `optional-skills/cybersecurity/penetration-testing/performing-privilege-escalation-assessment` |
| Platforms | all |
