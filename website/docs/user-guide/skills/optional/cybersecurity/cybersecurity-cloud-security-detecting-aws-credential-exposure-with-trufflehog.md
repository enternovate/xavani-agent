...
sidebar_label: "Detecting Aws Credential Exposure With Trufflehog"
description: "Detecting exposed AWS credentials in source code repositories, CI/CD pipelines, and configuration files using TruffleHog, git-secrets, and AWS-native detecti..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-aws-credential-exposure-with-trufflehog` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-aws-credential-exposure-with-trufflehog` |
| Platforms | all |
