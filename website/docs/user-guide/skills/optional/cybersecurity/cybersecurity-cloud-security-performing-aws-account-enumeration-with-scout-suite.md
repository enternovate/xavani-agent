...
sidebar_label: "Performing Aws Account Enumeration With Scout Suite"
description: "Perform comprehensive security posture assessment of AWS accounts using ScoutSuite to enumerate resources, identify misconfigurations, and generate actionabl..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-aws-account-enumeration-with-scout-suite` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-aws-account-enumeration-with-scout-suite` |
| Platforms | all |
