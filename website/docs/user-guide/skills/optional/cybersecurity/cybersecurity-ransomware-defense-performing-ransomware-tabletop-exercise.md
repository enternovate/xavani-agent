...
sidebar_label: "Performing Ransomware Tabletop Exercise"
description: "Plans and facilitates tabletop exercises simulating ransomware incidents to test organizational readiness, decision-making, and communication procedures"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-ransomware-tabletop-exercise` |
| Path | `optional-skills/cybersecurity/ransomware-defense/performing-ransomware-tabletop-exercise` |
| Platforms | all |
