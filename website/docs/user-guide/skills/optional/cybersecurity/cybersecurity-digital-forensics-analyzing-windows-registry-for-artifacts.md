...
sidebar_label: "Analyzing Windows Registry For Artifacts"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-windows-registry-for-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-windows-registry-for-artifacts` |
| Platforms | all |
