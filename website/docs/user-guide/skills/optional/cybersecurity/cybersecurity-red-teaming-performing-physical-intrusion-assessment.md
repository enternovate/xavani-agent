...
sidebar_label: "Performing Physical Intrusion Assessment"
description: "Conduct authorized physical penetration testing using tailgating, badge cloning, lock bypassing, and rogue device deployment to evaluate facility security co..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-physical-intrusion-assessment` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-physical-intrusion-assessment` |
| Platforms | all |
