...
sidebar_label: "Triaging Security Incident With Ir Playbook"
description: "Classify and prioritize security incidents using structured IR playbooks to determine severity, assign response teams, and initiate appropriate response proc..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/triaging-security-incident-with-ir-playbook` |
| Path | `optional-skills/cybersecurity/incident-response/triaging-security-incident-with-ir-playbook` |
| Platforms | all |
