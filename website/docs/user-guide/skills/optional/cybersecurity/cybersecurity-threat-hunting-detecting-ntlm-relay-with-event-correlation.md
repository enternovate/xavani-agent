...
sidebar_label: "Detecting Ntlm Relay With Event Correlation"
description: "Detect NTLM relay attacks through Windows Security Event correlation by analyzing Event 4624 LogonType 3 for IP-to-hostname mismatches, identifying Responder..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-ntlm-relay-with-event-correlation` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-ntlm-relay-with-event-correlation` |
| Platforms | all |
