---
title: "Detecting Beaconing Patterns With Zeek — Performs statistical analysis of Zeek conn"
sidebar_label: "Detecting Beaconing Patterns With Zeek"
description: "Performs statistical analysis of Zeek conn"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-beaconing-patterns-with-zeek` |
| Path | `optional-skills/cybersecurity/security-operations/detecting-beaconing-patterns-with-zeek` |
| Platforms | all |
