...
sidebar_label: "Performing Packet Injection Attack"
description: "Crafts and injects custom network packets using Scapy, hping3, and Nemesis during authorized security assessments to test firewall rules, IDS detection, prot..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-packet-injection-attack` |
| Path | `optional-skills/cybersecurity/network-security/performing-packet-injection-attack` |
| Platforms | all |
