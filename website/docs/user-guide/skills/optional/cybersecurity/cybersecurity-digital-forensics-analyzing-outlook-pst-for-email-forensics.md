...
sidebar_label: "Analyzing Outlook Pst For Email Forensics"
description: "Analyze Microsoft Outlook PST and OST files for email forensic evidence including message content, headers, attachments, deleted items, and metadata using li..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-outlook-pst-for-email-forensics` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-outlook-pst-for-email-forensics` |
| Platforms | all |
