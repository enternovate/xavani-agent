...
sidebar_label: "Implementing Cloud Trail Log Analysis"
description: "Implementing AWS CloudTrail log analysis for security monitoring, threat detection, and forensic investigation using Athena, CloudWatch Logs Insights, and SI..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-cloud-trail-log-analysis` |
| Path | `optional-skills/cybersecurity/cloud-security/implementing-cloud-trail-log-analysis` |
| Platforms | all |
