---
title: "Detecting Exfiltration Over Dns With Zeek — Detect DNS-based data exfiltration by analyzing Zeek dns"
sidebar_label: "Detecting Exfiltration Over Dns With Zeek"
description: "Detect DNS-based data exfiltration by analyzing Zeek dns"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-exfiltration-over-dns-with-zeek` |
| Path | `optional-skills/cybersecurity/network-security/detecting-exfiltration-over-dns-with-zeek` |
| Platforms | all |
