...
sidebar_label: "Performing Power Grid Cybersecurity Assessment"
description: "This skill covers conducting cybersecurity assessments of electric power grid infrastructure including generation facilities, transmission substations, distr..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-power-grid-cybersecurity-assessment` |
| Path | `optional-skills/cybersecurity/ot-ics-security/performing-power-grid-cybersecurity-assessment` |
| Platforms | all |
