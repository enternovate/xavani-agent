...
sidebar_label: "Collecting Indicators Of Compromise"
description: "Systematically collects, categorizes, and distributes indicators of compromise (IOCs) during and after security incidents to enable detection, blocking, and ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/collecting-indicators-of-compromise` |
| Path | `optional-skills/cybersecurity/incident-response/collecting-indicators-of-compromise` |
| Platforms | all |
