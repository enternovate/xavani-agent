...
sidebar_label: "Performing Network Packet Capture Analysis"
description: "Perform forensic analysis of network packet captures (PCAP/PCAPNG) using Wireshark, tshark, and tcpdump to reconstruct network communications, extract transf..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-network-packet-capture-analysis` |
| Path | `optional-skills/cybersecurity/digital-forensics/performing-network-packet-capture-analysis` |
| Platforms | all |
