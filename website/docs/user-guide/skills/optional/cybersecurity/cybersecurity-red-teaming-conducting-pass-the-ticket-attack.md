...
sidebar_label: "Conducting Pass The Ticket Attack"
description: "Pass-the-Ticket (PtT) is a lateral movement technique that uses stolen Kerberos tickets (TGT or TGS) to authenticate to services without knowing the user's p..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-pass-the-ticket-attack` |
| Path | `optional-skills/cybersecurity/red-teaming/conducting-pass-the-ticket-attack` |
| Platforms | all |
