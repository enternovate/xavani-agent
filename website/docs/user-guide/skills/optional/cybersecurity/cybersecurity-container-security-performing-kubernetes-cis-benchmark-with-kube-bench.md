...
sidebar_label: "Performing Kubernetes Cis Benchmark With Kube Bench"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-kubernetes-cis-benchmark-with-kube-bench` |
| Path | `optional-skills/cybersecurity/container-security/performing-kubernetes-cis-benchmark-with-kube-bench` |
| Platforms | all |
