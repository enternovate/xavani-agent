...
sidebar_label: "Detecting Qr Code Phishing With Email Security"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-qr-code-phishing-with-email-security` |
| Path | `optional-skills/cybersecurity/phishing-defense/detecting-qr-code-phishing-with-email-security` |
| Platforms | all |
