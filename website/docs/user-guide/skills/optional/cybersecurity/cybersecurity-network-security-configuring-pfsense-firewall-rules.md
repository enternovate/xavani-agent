...
sidebar_label: "Configuring Pfsense Firewall Rules"
description: "Configures pfSense firewall rules, NAT policies, VPN tunnels, and traffic shaping to enforce network segmentation, control traffic flow, and protect internal..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/configuring-pfsense-firewall-rules` |
| Path | `optional-skills/cybersecurity/network-security/configuring-pfsense-firewall-rules` |
| Platforms | all |
