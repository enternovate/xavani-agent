...
sidebar_label: "Securing Github Actions Workflows"
description: "This skill covers hardening GitHub Actions workflows against supply chain attacks, credential theft, and privilege escalation"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-github-actions-workflows` |
| Path | `optional-skills/cybersecurity/devsecops/securing-github-actions-workflows` |
| Platforms | all |
