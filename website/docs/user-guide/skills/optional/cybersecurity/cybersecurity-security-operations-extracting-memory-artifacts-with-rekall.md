...
description: "Uses Rekall memory forensics framework to analyze memory dumps for process hollowing, injected code via VAD anomalies, hidden processes, and rootkit detection"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/extracting-memory-artifacts-with-rekall` |
| Path | `optional-skills/cybersecurity/security-operations/extracting-memory-artifacts-with-rekall` |
| Platforms | all |
