---
title: "Analyzing Windows Amcache Artifacts — Parses and analyzes the Windows Amcache"
sidebar_label: "Analyzing Windows Amcache Artifacts"
description: "Parses and analyzes the Windows Amcache"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-windows-amcache-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-windows-amcache-artifacts` |
| Platforms | all |
