...
sidebar_label: "Conducting Domain Persistence With Dcsync"
description: "Perform DCSync attacks to replicate Active Directory credentials and establish domain persistence by extracting KRBTGT, Domain Admin, and service account has..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-domain-persistence-with-dcsync` |
| Path | `optional-skills/cybersecurity/red-teaming/conducting-domain-persistence-with-dcsync` |
| Platforms | all |
