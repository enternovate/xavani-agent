...
sidebar_label: "Implementing Pod Security Admission Controller"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-pod-security-admission-controller` |
| Path | `optional-skills/cybersecurity/container-security/implementing-pod-security-admission-controller` |
| Platforms | all |
