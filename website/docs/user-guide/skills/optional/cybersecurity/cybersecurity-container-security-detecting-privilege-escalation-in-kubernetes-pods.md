...
sidebar_label: "Detecting Privilege Escalation In Kubernetes Pods"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-privilege-escalation-in-kubernetes-pods` |
| Path | `optional-skills/cybersecurity/container-security/detecting-privilege-escalation-in-kubernetes-pods` |
| Platforms | all |
