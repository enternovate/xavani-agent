...
sidebar_label: "Scanning Docker Images With Trivy"
description: "Trivy is a comprehensive open-source vulnerability scanner by Aqua Security that detects vulnerabilities in OS packages, language-specific dependencies, misc..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/scanning-docker-images-with-trivy` |
| Path | `optional-skills/cybersecurity/container-security/scanning-docker-images-with-trivy` |
| Platforms | all |
