...
sidebar_label: "Analyzing Windows Event Logs In Splunk"
description: "Analyzes Windows Security, System, and Sysmon event logs in Splunk to detect authentication attacks, privilege escalation, persistence mechanisms, and latera..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-windows-event-logs-in-splunk` |
| Path | `optional-skills/cybersecurity/soc-operations/analyzing-windows-event-logs-in-splunk` |
| Platforms | all |
