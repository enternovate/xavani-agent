...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-log-forwarding-with-fluentd` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-log-forwarding-with-fluentd` |
| Platforms | all |
