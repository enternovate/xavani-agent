...
sidebar_label: "Implementing Soar Automation With Phantom"
description: "Implements Security Orchestration, Automation, and Response (SOAR) workflows using Splunk SOAR (formerly Phantom) to automate alert triage, IOC enrichment, c..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-soar-automation-with-phantom` |
| Path | `optional-skills/cybersecurity/soc-operations/implementing-soar-automation-with-phantom` |
| Platforms | all |
