...
sidebar_label: "Detecting Lateral Movement With Splunk"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-lateral-movement-with-splunk` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-lateral-movement-with-splunk` |
| Platforms | all |
