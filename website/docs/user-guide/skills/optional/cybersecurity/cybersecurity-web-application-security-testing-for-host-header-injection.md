...
sidebar_label: "Testing For Host Header Injection"
description: "Test web applications for HTTP Host header injection vulnerabilities to identify password reset poisoning, web cache poisoning, SSRF, and virtual host routin..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-for-host-header-injection` |
| Path | `optional-skills/cybersecurity/web-application-security/testing-for-host-header-injection` |
| Platforms | all |
