...
sidebar_label: "Performing Sca Dependency Scanning With Snyk"
description: "This skill covers implementing Software Composition Analysis (SCA) using Snyk to detect vulnerable open-source dependencies in CI/CD pipelines"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-sca-dependency-scanning-with-snyk` |
| Path | `optional-skills/cybersecurity/devsecops/performing-sca-dependency-scanning-with-snyk` |
| Platforms | all |
