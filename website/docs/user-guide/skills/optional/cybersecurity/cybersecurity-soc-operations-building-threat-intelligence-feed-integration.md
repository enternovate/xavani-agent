...
sidebar_label: "Building Threat Intelligence Feed Integration"
description: "Builds automated threat intelligence feed integration pipelines connecting STIX/TAXII feeds, open-source threat intel, and commercial TI platforms into SIEM ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-threat-intelligence-feed-integration` |
| Path | `optional-skills/cybersecurity/soc-operations/building-threat-intelligence-feed-integration` |
| Platforms | all |
