...
sidebar_label: "Performing Csrf Attack Simulation"
description: "Testing web applications for Cross-Site Request Forgery vulnerabilities by crafting forged requests that exploit authenticated user sessions during authorize..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-csrf-attack-simulation` |
| Path | `optional-skills/cybersecurity/web-application-security/performing-csrf-attack-simulation` |
| Platforms | all |
