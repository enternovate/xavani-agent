...
sidebar_label: "Performing Ransomware Response"
description: "Executes a structured ransomware incident response from initial detection through containment, forensic analysis, decryption assessment, recovery, and post-i..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-ransomware-response` |
| Path | `optional-skills/cybersecurity/incident-response/performing-ransomware-response` |
| Platforms | all |
