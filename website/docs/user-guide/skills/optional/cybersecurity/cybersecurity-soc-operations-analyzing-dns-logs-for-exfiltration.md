...
sidebar_label: "Analyzing Dns Logs For Exfiltration"
description: "Analyzes DNS query logs to detect data exfiltration via DNS tunneling, DGA domain communication, and covert C2 channels using entropy analysis, query volume ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-dns-logs-for-exfiltration` |
| Path | `optional-skills/cybersecurity/soc-operations/analyzing-dns-logs-for-exfiltration` |
| Platforms | all |
