...
sidebar_label: "Analyzing Threat Actor Ttps With Mitre Attack"
description: "MITRE ATT&CK is a globally-accessible knowledge base of adversary tactics, techniques, and procedures (TTPs) based on real-world observations"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-threat-actor-ttps-with-mitre-attack` |
| Path | `optional-skills/cybersecurity/threat-intelligence/analyzing-threat-actor-ttps-with-mitre-attack` |
| Platforms | all |
