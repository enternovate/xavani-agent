...
sidebar_label: "Performing Cloud Penetration Testing With Pacu"
description: "Performing authorized AWS penetration testing using Pacu, the open-source AWS exploitation framework, to enumerate IAM configurations, discover privilege esc..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-penetration-testing-with-pacu` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-cloud-penetration-testing-with-pacu` |
| Platforms | all |
