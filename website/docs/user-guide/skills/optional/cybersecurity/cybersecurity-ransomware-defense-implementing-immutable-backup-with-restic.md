...
description: "Implements immutable backup strategy using restic with S3-compatible storage and object lock for ransomware-resistant data protection"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-immutable-backup-with-restic` |
| Path | `optional-skills/cybersecurity/ransomware-defense/implementing-immutable-backup-with-restic` |
| Platforms | all |
