...
sidebar_label: "Performing Kubernetes Penetration Testing"
description: "Kubernetes penetration testing systematically evaluates cluster security by simulating attacker techniques against the API server, kubelet, etcd, pods, RBAC,..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-kubernetes-penetration-testing` |
| Path | `optional-skills/cybersecurity/container-security/performing-kubernetes-penetration-testing` |
| Platforms | all |
