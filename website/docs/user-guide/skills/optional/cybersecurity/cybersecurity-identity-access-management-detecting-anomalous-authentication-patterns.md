...
sidebar_label: "Detecting Anomalous Authentication Patterns"
description: "Detects anomalous authentication patterns using UEBA analytics, statistical baselines, and machine learning models to identify impossible travel, credential ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-anomalous-authentication-patterns` |
| Path | `optional-skills/cybersecurity/identity-access-management/detecting-anomalous-authentication-patterns` |
| Platforms | all |
