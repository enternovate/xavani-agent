...
sidebar_label: "Securing Aws Lambda Execution Roles"
description: "Securing AWS Lambda execution roles by implementing least-privilege IAM policies, applying permission boundaries, restricting resource-based policies, using ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-aws-lambda-execution-roles` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-aws-lambda-execution-roles` |
| Platforms | all |
