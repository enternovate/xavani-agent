...
sidebar_label: "Implementing Identity Governance With Sailpoint"
description: "Deploy SailPoint IdentityNow or IdentityIQ for identity governance and administration"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-identity-governance-with-sailpoint` |
| Path | `optional-skills/cybersecurity/identity-access-management/implementing-identity-governance-with-sailpoint` |
| Platforms | all |
