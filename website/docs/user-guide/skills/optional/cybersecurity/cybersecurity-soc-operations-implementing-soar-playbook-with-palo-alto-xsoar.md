...
sidebar_label: "Implementing Soar Playbook With Palo Alto Xsoar"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-soar-playbook-with-palo-alto-xsoar` |
| Path | `optional-skills/cybersecurity/soc-operations/implementing-soar-playbook-with-palo-alto-xsoar` |
| Platforms | all |
