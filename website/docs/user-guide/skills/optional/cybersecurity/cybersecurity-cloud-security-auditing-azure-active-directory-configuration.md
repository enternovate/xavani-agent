...
sidebar_label: "Auditing Azure Active Directory Configuration"
description: "Auditing Microsoft Entra ID (Azure Active Directory) configuration to identify risky authentication policies, overly permissive role assignments, stale accou..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-azure-active-directory-configuration` |
| Path | `optional-skills/cybersecurity/cloud-security/auditing-azure-active-directory-configuration` |
| Platforms | all |
