...
sidebar_label: "Testing Api For Broken Object Level Authorization"
description: "Tests REST and GraphQL APIs for Broken Object Level Authorization (BOLA/IDOR) vulnerabilities where an authenticated user can access or modify resources belo..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-api-for-broken-object-level-authorization` |
| Path | `optional-skills/cybersecurity/api-security/testing-api-for-broken-object-level-authorization` |
| Platforms | all |
