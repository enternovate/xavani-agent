...
sidebar_label: "Building Ransomware Playbook With Cisa Framework"
description: "Builds a structured ransomware incident response playbook aligned with the CISA StopRansomware Guide and NIST Cybersecurity Framework"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-ransomware-playbook-with-cisa-framework` |
| Path | `optional-skills/cybersecurity/ransomware-defense/building-ransomware-playbook-with-cisa-framework` |
| Platforms | all |
