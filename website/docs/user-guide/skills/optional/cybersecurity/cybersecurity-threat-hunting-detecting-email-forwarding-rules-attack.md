...
sidebar_label: "Detecting Email Forwarding Rules Attack"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-email-forwarding-rules-attack` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-email-forwarding-rules-attack` |
| Platforms | all |
