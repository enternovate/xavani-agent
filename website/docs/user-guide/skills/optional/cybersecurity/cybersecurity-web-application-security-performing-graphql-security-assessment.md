...
sidebar_label: "Performing Graphql Security Assessment"
description: "Assessing GraphQL API endpoints for introspection leaks, injection attacks, authorization flaws, and denial-of-service vulnerabilities during authorized secu..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-graphql-security-assessment` |
| Path | `optional-skills/cybersecurity/web-application-security/performing-graphql-security-assessment` |
| Platforms | all |
