...
sidebar_label: "Performing Lateral Movement With Wmiexec"
description: "Perform lateral movement across Windows networks using WMI-based remote execution techniques including Impacket wmiexec"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-lateral-movement-with-wmiexec` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-lateral-movement-with-wmiexec` |
| Platforms | all |
