...
sidebar_label: "Detecting Broken Object Property Level Authorization"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-broken-object-property-level-authorization` |
| Path | `optional-skills/cybersecurity/api-security/detecting-broken-object-property-level-authorization` |
| Platforms | all |
