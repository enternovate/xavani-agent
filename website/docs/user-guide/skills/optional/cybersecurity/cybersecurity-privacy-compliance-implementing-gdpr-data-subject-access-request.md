...
sidebar_label: "Implementing Gdpr Data Subject Access Request"
description: "Automates GDPR Data Subject Access Request (DSAR) workflows including identity verification, PII discovery across databases and files using regex and NER, da..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-gdpr-data-subject-access-request` |
| Path | `optional-skills/cybersecurity/privacy-compliance/implementing-gdpr-data-subject-access-request` |
| Platforms | all |
