...
sidebar_label: "Detecting Deepfake Audio In Vishing Attacks"
description: "Detects AI-generated deepfake audio used in voice phishing (vishing) attacks by extracting spectral features (MFCC, spectral centroid, spectral contrast, zer..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-deepfake-audio-in-vishing-attacks` |
| Path | `optional-skills/cybersecurity/social-engineering-defense/detecting-deepfake-audio-in-vishing-attacks` |
| Platforms | all |
