...
sidebar_label: "Bypassing Authentication With Forced Browsing"
description: "Discovering and accessing unprotected pages, APIs, and administrative interfaces by enumerating URLs and bypassing authentication controls during authorized ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/bypassing-authentication-with-forced-browsing` |
| Path | `optional-skills/cybersecurity/web-application-security/bypassing-authentication-with-forced-browsing` |
| Platforms | all |
