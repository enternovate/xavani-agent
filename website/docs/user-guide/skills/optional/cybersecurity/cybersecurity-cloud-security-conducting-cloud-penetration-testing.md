...
sidebar_label: "Conducting Cloud Penetration Testing"
description: "This skill outlines methodologies for performing authorized penetration testing against AWS, Azure, and GCP cloud environments"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-cloud-penetration-testing` |
| Path | `optional-skills/cybersecurity/cloud-security/conducting-cloud-penetration-testing` |
| Platforms | all |
