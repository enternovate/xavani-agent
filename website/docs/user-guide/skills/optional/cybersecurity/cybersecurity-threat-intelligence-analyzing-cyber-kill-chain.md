...
sidebar_label: "Analyzing Cyber Kill Chain"
description: "Analyzes intrusion activity against the Lockheed Martin Cyber Kill Chain framework to identify which phases an adversary has completed, where defenses succee..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-cyber-kill-chain` |
| Path | `optional-skills/cybersecurity/threat-intelligence/analyzing-cyber-kill-chain` |
| Platforms | all |
