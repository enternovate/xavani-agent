...
sidebar_label: "Detecting Serverless Function Injection"
description: "Detects and prevents code injection attacks targeting serverless functions (AWS Lambda, Azure Functions, Google Cloud Functions) through event source poisoni..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-serverless-function-injection` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-serverless-function-injection` |
| Platforms | all |
