...
description: "Configure AIDE (Advanced Intrusion Detection Environment) for file integrity monitoring including baseline creation, scheduled integrity checks, change detec..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-file-integrity-monitoring-with-aide` |
| Path | `optional-skills/cybersecurity/endpoint-security/implementing-file-integrity-monitoring-with-aide` |
| Platforms | all |
