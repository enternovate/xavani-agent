...
sidebar_label: "Testing Mobile Api Authentication"
description: "Tests authentication and authorization mechanisms in mobile application APIs to identify broken authentication, insecure token management, session fixation, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-mobile-api-authentication` |
| Path | `optional-skills/cybersecurity/mobile-security/testing-mobile-api-authentication` |
| Platforms | all |
