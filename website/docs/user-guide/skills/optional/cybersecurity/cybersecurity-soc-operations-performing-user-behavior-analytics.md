...
sidebar_label: "Performing User Behavior Analytics"
description: "Performs User and Entity Behavior Analytics (UEBA) to detect anomalous user activities including impossible travel, unusual access patterns, privilege abuse,..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-user-behavior-analytics` |
| Path | `optional-skills/cybersecurity/soc-operations/performing-user-behavior-analytics` |
| Platforms | all |
