...
sidebar_label: "Testing For Xss Vulnerabilities With Burpsuite"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-for-xss-vulnerabilities-with-burpsuite` |
| Path | `optional-skills/cybersecurity/web-application-security/testing-for-xss-vulnerabilities-with-burpsuite` |
| Platforms | all |
