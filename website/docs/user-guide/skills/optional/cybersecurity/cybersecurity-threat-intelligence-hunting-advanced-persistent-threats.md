...
sidebar_label: "Hunting Advanced Persistent Threats"
description: "Proactively hunts for Advanced Persistent Threat (APT) activity within enterprise environments using hypothesis-driven searches across endpoint telemetry, ne..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-advanced-persistent-threats` |
| Path | `optional-skills/cybersecurity/threat-intelligence/hunting-advanced-persistent-threats` |
| Platforms | all |
