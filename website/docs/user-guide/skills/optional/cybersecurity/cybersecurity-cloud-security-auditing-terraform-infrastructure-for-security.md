...
sidebar_label: "Auditing Terraform Infrastructure For Security"
description: "Auditing Terraform infrastructure-as-code for security misconfigurations using Checkov, tfsec, Terrascan, and OPA/Rego policies to detect overly permissive I..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-terraform-infrastructure-for-security` |
| Path | `optional-skills/cybersecurity/cloud-security/auditing-terraform-infrastructure-for-security` |
| Platforms | all |
