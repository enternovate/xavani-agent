...
sidebar_label: "Performing Credential Access With Lazagne"
description: "Extract stored credentials from compromised endpoints using the LaZagne post-exploitation tool to recover passwords from browsers, databases, system vaults, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-credential-access-with-lazagne` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-credential-access-with-lazagne` |
| Platforms | all |
