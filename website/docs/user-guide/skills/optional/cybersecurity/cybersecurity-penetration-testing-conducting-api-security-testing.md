...
sidebar_label: "Conducting Api Security Testing"
description: "Conducts security testing of REST, GraphQL, and gRPC APIs to identify vulnerabilities in authentication, authorization, rate limiting, input validation, and ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-api-security-testing` |
| Path | `optional-skills/cybersecurity/penetration-testing/conducting-api-security-testing` |
| Platforms | all |
