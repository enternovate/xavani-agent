...
sidebar_label: "Performing Dns Tunneling Detection"
description: "Detects DNS tunneling by computing Shannon entropy of DNS query names, analyzing query length distributions, inspecting TXT record payloads, and identifying ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-dns-tunneling-detection` |
| Path | `optional-skills/cybersecurity/security-operations/performing-dns-tunneling-detection` |
| Platforms | all |
