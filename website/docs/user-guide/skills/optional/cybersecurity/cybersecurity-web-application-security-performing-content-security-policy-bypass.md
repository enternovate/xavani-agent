...
sidebar_label: "Performing Content Security Policy Bypass"
description: "Analyze and bypass Content Security Policy implementations to achieve cross-site scripting by exploiting misconfigurations, JSONP endpoints, unsafe directive..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-content-security-policy-bypass` |
| Path | `optional-skills/cybersecurity/web-application-security/performing-content-security-policy-bypass` |
| Platforms | all |
