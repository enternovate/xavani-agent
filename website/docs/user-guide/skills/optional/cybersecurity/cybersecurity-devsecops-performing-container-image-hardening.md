...
sidebar_label: "Performing Container Image Hardening"
description: "This skill covers hardening container images by minimizing attack surface, removing unnecessary packages, implementing multi-stage builds, configuring non-ro..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-container-image-hardening` |
| Path | `optional-skills/cybersecurity/devsecops/performing-container-image-hardening` |
| Platforms | all |
