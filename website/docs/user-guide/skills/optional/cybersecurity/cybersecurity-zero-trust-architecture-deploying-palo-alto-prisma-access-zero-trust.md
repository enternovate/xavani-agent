...
sidebar_label: "Deploying Palo Alto Prisma Access Zero Trust"
description: "Deploying Palo Alto Networks Prisma Access for SASE-based zero trust network access using GlobalProtect agents, ZTNA Connectors, security policy enforcement,..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/deploying-palo-alto-prisma-access-zero-trust` |
| Path | `optional-skills/cybersecurity/zero-trust-architecture/deploying-palo-alto-prisma-access-zero-trust` |
| Platforms | all |
