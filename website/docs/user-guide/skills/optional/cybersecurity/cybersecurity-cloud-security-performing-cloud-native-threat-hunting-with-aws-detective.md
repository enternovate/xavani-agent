...
sidebar_label: "Performing Cloud Native Threat Hunting With Aws Detective"
description: "Hunt for threats in AWS environments using Detective behavior graphs, entity investigation timelines, GuardDuty finding correlation, and automated entity pro..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-native-threat-hunting-with-aws-detective` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-cloud-native-threat-hunting-with-aws-detective` |
| Platforms | all |
