...
sidebar_label: "Building Incident Response Dashboard"
description: "Builds real-time incident response dashboards in Splunk, Elastic, or Grafana to provide SOC analysts and leadership with situational awareness during active ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-incident-response-dashboard` |
| Path | `optional-skills/cybersecurity/soc-operations/building-incident-response-dashboard` |
| Platforms | all |
