...
sidebar_label: "Performing Gcp Security Assessment With Forseti"
description: "Performing comprehensive security assessments of Google Cloud Platform environments using Forseti Security, Security Command Center, and gcloud CLI to audit ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-gcp-security-assessment-with-forseti` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-gcp-security-assessment-with-forseti` |
| Platforms | all |
