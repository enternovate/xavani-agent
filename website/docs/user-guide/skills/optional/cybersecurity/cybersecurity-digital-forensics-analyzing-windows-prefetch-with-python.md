...
sidebar_label: "Analyzing Windows Prefetch With Python"
description: "Parse Windows Prefetch files using the windowsprefetch Python library to reconstruct application execution history, detect renamed or masquerading binaries, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-windows-prefetch-with-python` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-windows-prefetch-with-python` |
| Platforms | all |
