...
sidebar_label: "Analyzing Typosquatting Domains With Dnstwist"
description: "Detect typosquatting, homograph phishing, and brand impersonation domains using dnstwist to generate domain permutations and identify registered lookalike do..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-typosquatting-domains-with-dnstwist` |
| Path | `optional-skills/cybersecurity/threat-intelligence/analyzing-typosquatting-domains-with-dnstwist` |
| Platforms | all |
