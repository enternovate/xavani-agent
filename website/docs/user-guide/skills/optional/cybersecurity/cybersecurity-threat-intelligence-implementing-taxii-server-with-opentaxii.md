...
sidebar_label: "Implementing Taxii Server With Opentaxii"
description: "Deploy and configure an OpenTAXII server to share and consume STIX-formatted cyber threat intelligence using the TAXII 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-taxii-server-with-opentaxii` |
| Path | `optional-skills/cybersecurity/threat-intelligence/implementing-taxii-server-with-opentaxii` |
| Platforms | all |
