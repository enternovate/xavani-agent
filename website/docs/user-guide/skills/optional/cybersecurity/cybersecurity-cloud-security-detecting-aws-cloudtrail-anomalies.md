...
sidebar_label: "Detecting Aws Cloudtrail Anomalies"
description: "Detect unusual API call patterns in AWS CloudTrail logs using boto3, statistical baselining, and behavioral analysis to identify credential compromise, privi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-aws-cloudtrail-anomalies` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-aws-cloudtrail-anomalies` |
| Platforms | all |
