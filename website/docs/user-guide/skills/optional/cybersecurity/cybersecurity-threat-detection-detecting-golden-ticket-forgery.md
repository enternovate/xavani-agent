...
description: "Detect Kerberos Golden Ticket forgery by analyzing Windows Event ID 4769 for RC4 encryption downgrades (0x17), abnormal ticket lifetimes, and krbtgt account ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-golden-ticket-forgery` |
| Path | `optional-skills/cybersecurity/threat-detection/detecting-golden-ticket-forgery` |
| Platforms | all |
