...
sidebar_label: "Executing Phishing Simulation Campaign"
description: "Executes authorized phishing simulation campaigns to assess an organization's susceptibility to email-based social engineering attacks"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/executing-phishing-simulation-campaign` |
| Path | `optional-skills/cybersecurity/penetration-testing/executing-phishing-simulation-campaign` |
| Platforms | all |
