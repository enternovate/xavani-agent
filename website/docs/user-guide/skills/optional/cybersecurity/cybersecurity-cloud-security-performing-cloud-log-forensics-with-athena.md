...
sidebar_label: "Performing Cloud Log Forensics With Athena"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-log-forensics-with-athena` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-cloud-log-forensics-with-athena` |
| Platforms | all |
...
WITH SERDEPROPERTIES (
    'serialization.format' = '1',
    'input.regex' = '([^ ]*) ([^ ]*) ([^ ]*) ([^ ]*):([0-9]*) ([^ ]*)[:-](https://github.com/enternovate/xavani-agent/blob/main/optional-skills/cybersecurity/cloud-security/performing-cloud-log-forensics-with-athena/[0-9]*) ([-.0-9]*) ([-.0-9]*) ([-.0-9]*) (|[0-9]*) (-|[0-9]*) ([-0-9]*) ([-0-9]*) \"([^ ]*) (.*) (- |[^ ]*)\" \"([^\"]*)\" ([A-Z0-9-_]+) ([A-Za-z0-9.-]*) ([^ ]*) \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" ([-.0-9]*) ([^ ]*) \"([^\"]*)\" \"([^\"]*)\" \"([^ ]*)\" \"([^\"]*)\" \"([^ ]*)\" \"([^ ]*)\" \"([^ ]*)\"'
)
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat'
OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
