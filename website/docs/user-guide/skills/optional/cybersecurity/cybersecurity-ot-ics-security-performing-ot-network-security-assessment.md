...
sidebar_label: "Performing Ot Network Security Assessment"
description: "This skill covers conducting comprehensive security assessments of Operational Technology (OT) networks including SCADA systems, DCS architectures, and indus..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-ot-network-security-assessment` |
| Path | `optional-skills/cybersecurity/ot-ics-security/performing-ot-network-security-assessment` |
| Platforms | all |
