...
sidebar_label: "Detecting Attacks On Historian Servers"
description: "Detect cyber attacks targeting OT historian servers (OSIsoft PI, Ignition, Wonderware) that sit at the IT/OT boundary and serve as pivot points for lateral m..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-attacks-on-historian-servers` |
| Path | `optional-skills/cybersecurity/ot-ics-security/detecting-attacks-on-historian-servers` |
| Platforms | all |
