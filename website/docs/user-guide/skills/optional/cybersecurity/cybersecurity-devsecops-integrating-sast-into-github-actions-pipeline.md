...
sidebar_label: "Integrating Sast Into Github Actions Pipeline"
description: "This skill covers integrating Static Application Security Testing (SAST) tools—CodeQL and Semgrep—into GitHub Actions CI/CD pipelines"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/integrating-sast-into-github-actions-pipeline` |
| Path | `optional-skills/cybersecurity/devsecops/integrating-sast-into-github-actions-pipeline` |
| Platforms | all |
