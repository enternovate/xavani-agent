...
sidebar_label: "Analyzing Lnk File And Jump List Artifacts"
description: "Analyze Windows LNK shortcut files and Jump List artifacts to establish evidence of file access, program execution, and user activity using LECmd, JLECmd, an..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-lnk-file-and-jump-list-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-lnk-file-and-jump-list-artifacts` |
| Platforms | all |
