...
sidebar_label: "Executing Active Directory Attack Simulation"
description: "Executes authorized attack simulations against Active Directory environments to identify misconfigurations, weak credentials, dangerous privilege paths, and ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/executing-active-directory-attack-simulation` |
| Path | `optional-skills/cybersecurity/penetration-testing/executing-active-directory-attack-simulation` |
| Platforms | all |
