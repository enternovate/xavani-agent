...
sidebar_label: "Performing Insider Threat Investigation"
description: "Investigates insider threat incidents involving employees, contractors, or trusted partners who misuse authorized access to steal data, sabotage systems, or ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-insider-threat-investigation` |
| Path | `optional-skills/cybersecurity/incident-response/performing-insider-threat-investigation` |
| Platforms | all |
