...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-pass-the-ticket-attacks` |
| Path | `optional-skills/cybersecurity/threat-detection/detecting-pass-the-ticket-attacks` |
| Platforms | all |
