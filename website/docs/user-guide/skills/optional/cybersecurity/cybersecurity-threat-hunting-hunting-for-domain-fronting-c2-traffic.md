...
description: "Detect domain fronting C2 traffic by analyzing SNI vs HTTP Host header mismatches in proxy logs and TLS certificate discrepancies using pyOpenSSL for certifi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-domain-fronting-c2-traffic` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-domain-fronting-c2-traffic` |
| Platforms | all |
