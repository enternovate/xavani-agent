...
sidebar_label: "Securing Kubernetes On Cloud"
description: "This skill covers hardening managed Kubernetes clusters on EKS, AKS, and GKE by implementing Pod Security Standards, network policies, workload identity, RBA..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-kubernetes-on-cloud` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-kubernetes-on-cloud` |
| Platforms | all |
