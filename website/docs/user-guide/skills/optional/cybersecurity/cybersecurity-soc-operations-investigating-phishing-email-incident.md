...
sidebar_label: "Investigating Phishing Email Incident"
description: "Investigates phishing email incidents from initial user report through header analysis, URL/attachment detonation, impacted user identification, and containm..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/investigating-phishing-email-incident` |
| Path | `optional-skills/cybersecurity/soc-operations/investigating-phishing-email-incident` |
| Platforms | all |
