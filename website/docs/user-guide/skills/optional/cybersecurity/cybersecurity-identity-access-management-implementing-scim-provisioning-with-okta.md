---
title: "Implementing Scim Provisioning With Okta — Implement automated user provisioning and deprovisioning using SCIM 2"
sidebar_label: "Implementing Scim Provisioning With Okta"
description: "Implement automated user provisioning and deprovisioning using SCIM 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-scim-provisioning-with-okta` |
| Path | `optional-skills/cybersecurity/identity-access-management/implementing-scim-provisioning-with-okta` |
| Platforms | all |
