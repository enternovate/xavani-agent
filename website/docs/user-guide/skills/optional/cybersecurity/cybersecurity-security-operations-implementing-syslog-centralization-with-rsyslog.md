...
description: "Configure rsyslog for centralized log collection with TLS encryption, custom templates, and log rotation"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-syslog-centralization-with-rsyslog` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-syslog-centralization-with-rsyslog` |
| Platforms | all |
