...
sidebar_label: "Securing Api Gateway With Aws Waf"
description: "Securing API Gateway endpoints with AWS WAF by configuring managed rule groups for OWASP Top 10 protection, creating custom rate limiting rules, implementing..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-api-gateway-with-aws-waf` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-api-gateway-with-aws-waf` |
| Platforms | all |
