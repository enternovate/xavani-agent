...
sidebar_label: "Integrating Dast With Owasp Zap In Pipeline"
description: "This skill covers integrating OWASP ZAP (Zed Attack Proxy) for Dynamic Application Security Testing in CI/CD pipelines"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/integrating-dast-with-owasp-zap-in-pipeline` |
| Path | `optional-skills/cybersecurity/devsecops/integrating-dast-with-owasp-zap-in-pipeline` |
| Platforms | all |
