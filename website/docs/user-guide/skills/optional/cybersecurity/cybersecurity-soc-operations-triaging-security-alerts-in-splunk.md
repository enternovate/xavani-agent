...
sidebar_label: "Triaging Security Alerts In Splunk"
description: "Triages security alerts in Splunk Enterprise Security by classifying severity, investigating notable events, correlating related telemetry, and making escala..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/triaging-security-alerts-in-splunk` |
| Path | `optional-skills/cybersecurity/soc-operations/triaging-security-alerts-in-splunk` |
| Platforms | all |
