...
sidebar_label: "Performing Privilege Escalation On Linux"
description: "Linux privilege escalation involves elevating from a low-privilege user account to root access on a compromised system"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-privilege-escalation-on-linux` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-privilege-escalation-on-linux` |
| Platforms | all |
