...
sidebar_label: "Performing Service Account Credential Rotation"
description: "Automate credential rotation for service accounts across Active Directory, cloud platforms, and application databases to eliminate stale secrets and reduce c..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-service-account-credential-rotation` |
| Path | `optional-skills/cybersecurity/identity-access-management/performing-service-account-credential-rotation` |
| Platforms | all |
