...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-red-team-phishing-with-gophish` |
| Path | `optional-skills/cybersecurity/security-operations/performing-red-team-phishing-with-gophish` |
| Platforms | all |
