...
sidebar_label: "Analyzing Windows Shellbag Artifacts"
description: "Analyze Windows Shellbag registry artifacts to reconstruct folder browsing activity, detect access to removable media and network shares, and establish user ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-windows-shellbag-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-windows-shellbag-artifacts` |
| Platforms | all |
