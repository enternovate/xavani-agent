...
sidebar_label: "Performing Kerberoasting Attack"
description: "Kerberoasting is a post-exploitation technique that targets service accounts in Active Directory by requesting Kerberos TGS (Ticket Granting Service) tickets..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-kerberoasting-attack` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-kerberoasting-attack` |
| Platforms | all |
