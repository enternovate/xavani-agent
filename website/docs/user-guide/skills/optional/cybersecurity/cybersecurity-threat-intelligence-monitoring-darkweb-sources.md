...
sidebar_label: "Monitoring Darkweb Sources"
description: "Monitors dark web forums, marketplaces, paste sites, and ransomware leak sites for mentions of organizational assets, leaked credentials, threatened attacks,..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/monitoring-darkweb-sources` |
| Path | `optional-skills/cybersecurity/threat-intelligence/monitoring-darkweb-sources` |
| Platforms | all |
