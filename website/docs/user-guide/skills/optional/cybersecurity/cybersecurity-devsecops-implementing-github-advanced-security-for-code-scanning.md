...
sidebar_label: "Implementing Github Advanced Security For Code Scanning"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-github-advanced-security-for-code-scanning` |
| Path | `optional-skills/cybersecurity/devsecops/implementing-github-advanced-security-for-code-scanning` |
| Platforms | all |
