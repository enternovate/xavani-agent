...
description: "Detect AWS IAM privilege escalation paths using boto3 and Cloudsplaining policy analysis to identify overly permissive policies, dangerous permission combina..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-aws-iam-privilege-escalation` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-aws-iam-privilege-escalation` |
| Platforms | all |
