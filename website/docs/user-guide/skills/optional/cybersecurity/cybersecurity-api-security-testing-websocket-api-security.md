...
sidebar_label: "Testing Websocket Api Security"
description: "Tests WebSocket API implementations for security vulnerabilities including missing authentication on WebSocket upgrade, Cross-Site WebSocket Hijacking (CSWSH..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-websocket-api-security` |
| Path | `optional-skills/cybersecurity/api-security/testing-websocket-api-security` |
| Platforms | all |
