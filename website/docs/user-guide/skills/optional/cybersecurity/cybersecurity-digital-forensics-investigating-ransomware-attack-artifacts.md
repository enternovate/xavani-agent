...
sidebar_label: "Investigating Ransomware Attack Artifacts"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/investigating-ransomware-attack-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/investigating-ransomware-attack-artifacts` |
| Platforms | all |
