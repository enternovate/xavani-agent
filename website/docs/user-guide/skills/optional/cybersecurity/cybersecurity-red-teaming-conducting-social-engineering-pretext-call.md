...
sidebar_label: "Conducting Social Engineering Pretext Call"
description: "Plan and execute authorized vishing (voice phishing) pretext calls to assess employee susceptibility to social engineering and evaluate security awareness co..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-social-engineering-pretext-call` |
| Path | `optional-skills/cybersecurity/red-teaming/conducting-social-engineering-pretext-call` |
| Platforms | all |
