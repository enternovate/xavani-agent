...
sidebar_label: "Performing Scada Hmi Security Assessment"
description: "Perform security assessments of SCADA Human-Machine Interface (HMI) systems to identify vulnerabilities in web-based HMIs, thin-client configurations, authen..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-scada-hmi-security-assessment` |
| Path | `optional-skills/cybersecurity/ot-ics-security/performing-scada-hmi-security-assessment` |
| Platforms | all |
