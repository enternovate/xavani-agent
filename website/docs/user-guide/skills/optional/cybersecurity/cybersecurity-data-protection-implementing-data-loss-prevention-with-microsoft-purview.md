...
sidebar_label: "Implementing Data Loss Prevention With Microsoft Purview"
description: "Implements data loss prevention policies using Microsoft Purview to protect sensitive information across Exchange Online, SharePoint, OneDrive, Teams, endpoi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-data-loss-prevention-with-microsoft-purview` |
| Path | `optional-skills/cybersecurity/data-protection/implementing-data-loss-prevention-with-microsoft-purview` |
| Platforms | all |
...
- **nist_csf**: PR.DS-01, PR.DS-02, PR.DS-10, GV.PO-01
- **license**: Apache-2.0
- **author**: mukul975
