...
sidebar_label: "Recovering From Ransomware Attack"
description: "Executes structured recovery from a ransomware incident following NIST and CISA frameworks, including environment isolation, forensic evidence preservation, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/recovering-from-ransomware-attack` |
| Path | `optional-skills/cybersecurity/ransomware-defense/recovering-from-ransomware-attack` |
| Platforms | all |
