...
sidebar_label: "Performing Entitlement Review With Sailpoint Iiq"
description: "Performs entitlement review and access certification campaigns using SailPoint IdentityIQ including manager certifications, targeted entitlement reviews, rol..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-entitlement-review-with-sailpoint-iiq` |
| Path | `optional-skills/cybersecurity/identity-access-management/performing-entitlement-review-with-sailpoint-iiq` |
| Platforms | all |
