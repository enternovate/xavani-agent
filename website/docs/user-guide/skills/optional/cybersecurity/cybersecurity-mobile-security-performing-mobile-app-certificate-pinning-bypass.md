...
sidebar_label: "Performing Mobile App Certificate Pinning Bypass"
description: "Bypasses SSL/TLS certificate pinning implementations in Android and iOS applications to enable traffic interception during authorized security assessments"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-mobile-app-certificate-pinning-bypass` |
| Path | `optional-skills/cybersecurity/mobile-security/performing-mobile-app-certificate-pinning-bypass` |
| Platforms | all |
