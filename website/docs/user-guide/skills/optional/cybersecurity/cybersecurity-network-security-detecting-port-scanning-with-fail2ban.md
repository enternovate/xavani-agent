...
sidebar_label: "Detecting Port Scanning With Fail2Ban"
description: "Configures Fail2ban with custom filters and actions to detect port scanning activity, SSH brute force attempts, and network reconnaissance, automatically ban..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-port-scanning-with-fail2ban` |
| Path | `optional-skills/cybersecurity/network-security/detecting-port-scanning-with-fail2ban` |
| Platforms | all |
