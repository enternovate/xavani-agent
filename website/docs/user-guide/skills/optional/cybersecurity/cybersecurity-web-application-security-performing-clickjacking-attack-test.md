...
sidebar_label: "Performing Clickjacking Attack Test"
description: "Testing web applications for clickjacking vulnerabilities by assessing frame embedding controls and crafting proof-of-concept overlay attacks during authoriz..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-clickjacking-attack-test` |
| Path | `optional-skills/cybersecurity/web-application-security/performing-clickjacking-attack-test` |
| Platforms | all |
