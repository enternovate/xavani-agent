...
sidebar_label: "Performing Aws Privilege Escalation Assessment"
description: "Performing authorized privilege escalation assessments in AWS environments to identify IAM misconfigurations that allow users or roles to elevate their permi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-aws-privilege-escalation-assessment` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-aws-privilege-escalation-assessment` |
| Platforms | all |
