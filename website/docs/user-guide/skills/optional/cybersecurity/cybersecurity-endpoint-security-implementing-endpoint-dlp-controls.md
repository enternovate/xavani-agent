...
sidebar_label: "Implementing Endpoint Dlp Controls"
description: "Implements endpoint Data Loss Prevention (DLP) controls to detect and prevent sensitive data exfiltration through email, USB, cloud storage, and printing"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-endpoint-dlp-controls` |
| Path | `optional-skills/cybersecurity/endpoint-security/implementing-endpoint-dlp-controls` |
| Platforms | all |
