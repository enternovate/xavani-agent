...
description: "Configure ModSecurity WAF with OWASP Core Rule Set (CRS) for web application logging, tune rules to reduce false positives, analyze audit logs for attack det..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-web-application-logging-with-modsecurity` |
| Path | `optional-skills/cybersecurity/web-application-security/implementing-web-application-logging-with-modsecurity` |
| Platforms | all |
