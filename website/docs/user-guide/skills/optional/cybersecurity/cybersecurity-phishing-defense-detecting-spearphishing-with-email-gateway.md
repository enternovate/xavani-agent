...
sidebar_label: "Detecting Spearphishing With Email Gateway"
description: "Spearphishing targets specific individuals using personalized, researched content that bypasses generic spam filters"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-spearphishing-with-email-gateway` |
| Path | `optional-skills/cybersecurity/phishing-defense/detecting-spearphishing-with-email-gateway` |
| Platforms | all |
