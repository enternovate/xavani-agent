---
title: "Performing Oauth Scope Minimization Review — Performs OAuth 2"
sidebar_label: "Performing Oauth Scope Minimization Review"
description: "Performs OAuth 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-oauth-scope-minimization-review` |
| Path | `optional-skills/cybersecurity/identity-access-management/performing-oauth-scope-minimization-review` |
| Platforms | all |
