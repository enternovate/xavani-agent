...
sidebar_label: "Testing For Json Web Token Vulnerabilities"
description: "Test JWT implementations for critical vulnerabilities including algorithm confusion, none algorithm bypass, kid parameter injection, and weak secret exploita..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-for-json-web-token-vulnerabilities` |
| Path | `optional-skills/cybersecurity/web-application-security/testing-for-json-web-token-vulnerabilities` |
| Platforms | all |
