...
sidebar_label: "Building Ioc Enrichment Pipeline With Opencti"
description: "OpenCTI is an open-source platform for managing cyber threat intelligence knowledge, built on STIX 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-ioc-enrichment-pipeline-with-opencti` |
| Path | `optional-skills/cybersecurity/threat-intelligence/building-ioc-enrichment-pipeline-with-opencti` |
| Platforms | all |
