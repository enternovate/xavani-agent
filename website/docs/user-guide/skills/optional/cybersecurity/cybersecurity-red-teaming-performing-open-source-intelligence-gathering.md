...
sidebar_label: "Performing Open Source Intelligence Gathering"
description: "Open Source Intelligence (OSINT) gathering is the first active phase of a red team engagement, where operators collect publicly available information about t..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-open-source-intelligence-gathering` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-open-source-intelligence-gathering` |
| Platforms | all |
