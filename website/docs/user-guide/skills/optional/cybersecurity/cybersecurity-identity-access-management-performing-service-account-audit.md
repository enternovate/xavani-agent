...
sidebar_label: "Performing Service Account Audit"
description: "Audit service accounts across enterprise infrastructure to identify orphaned, over-privileged, and non-compliant accounts"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-service-account-audit` |
| Path | `optional-skills/cybersecurity/identity-access-management/performing-service-account-audit` |
| Platforms | all |
