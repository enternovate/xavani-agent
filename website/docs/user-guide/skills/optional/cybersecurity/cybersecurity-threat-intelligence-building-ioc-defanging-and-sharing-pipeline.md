...
sidebar_label: "Building Ioc Defanging And Sharing Pipeline"
description: "Build an automated pipeline to defang indicators of compromise (URLs, IPs, domains, emails) for safe sharing and distribute them in STIX format through TAXII..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-ioc-defanging-and-sharing-pipeline` |
| Path | `optional-skills/cybersecurity/threat-intelligence/building-ioc-defanging-and-sharing-pipeline` |
| Platforms | all |
...
class IOCExtractor:
    ...
    PATTERNS = {
        ...
        "domain": r'\b(?:[a-zA-Z0-9](https://github.com/enternovate/xavani-agent/blob/main/optional-skills/cybersecurity/threat-intelligence/building-ioc-defanging-and-sharing-pipeline/?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,}\b',
        "url": r'https?://[^\s<>"{}|\\^`\[\]]+',
