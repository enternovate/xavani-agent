...
sidebar_label: "Performing Security Headers Audit"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-security-headers-audit` |
| Path | `optional-skills/cybersecurity/web-application-security/performing-security-headers-audit` |
| Platforms | all |
