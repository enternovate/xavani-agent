...
sidebar_label: "Analyzing Cloud Storage Access Patterns"
description: "Detect abnormal access patterns in AWS S3, GCS, and Azure Blob Storage by analyzing CloudTrail Data Events, GCS audit logs, and Azure Storage Analytics"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-cloud-storage-access-patterns` |
| Path | `optional-skills/cybersecurity/cloud-security/analyzing-cloud-storage-access-patterns` |
| Platforms | all |
