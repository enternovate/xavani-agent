...
sidebar_label: "Performing Initial Access With Evilginx3"
description: "Perform authorized initial access using EvilGinx3 adversary-in-the-middle phishing framework to capture session tokens and bypass multi-factor authentication..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-initial-access-with-evilginx3` |
| Path | `optional-skills/cybersecurity/red-teaming/performing-initial-access-with-evilginx3` |
| Platforms | all |
