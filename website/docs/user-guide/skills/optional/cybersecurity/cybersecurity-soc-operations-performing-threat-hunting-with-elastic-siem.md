...
sidebar_label: "Performing Threat Hunting With Elastic Siem"
description: "Performs proactive threat hunting in Elastic Security SIEM using KQL/EQL queries, detection rules, and Timeline investigation to identify threats that evade ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-threat-hunting-with-elastic-siem` |
| Path | `optional-skills/cybersecurity/soc-operations/performing-threat-hunting-with-elastic-siem` |
| Platforms | all |
