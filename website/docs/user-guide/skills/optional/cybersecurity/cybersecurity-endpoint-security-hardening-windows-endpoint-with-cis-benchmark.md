...
sidebar_label: "Hardening Windows Endpoint With Cis Benchmark"
description: "Hardens Windows endpoints using CIS (Center for Internet Security) Benchmark recommendations to reduce attack surface, enforce security baselines, and meet c..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hardening-windows-endpoint-with-cis-benchmark` |
| Path | `optional-skills/cybersecurity/endpoint-security/hardening-windows-endpoint-with-cis-benchmark` |
| Platforms | all |
