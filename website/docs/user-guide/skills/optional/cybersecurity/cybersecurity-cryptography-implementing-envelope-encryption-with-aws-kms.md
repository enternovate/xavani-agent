...
sidebar_label: "Implementing Envelope Encryption With Aws Kms"
description: "Envelope encryption is a strategy where data is encrypted with a data encryption key (DEK), and the DEK itself is encrypted with a master key (KEK) managed b..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-envelope-encryption-with-aws-kms` |
| Path | `optional-skills/cybersecurity/cryptography/implementing-envelope-encryption-with-aws-kms` |
| Platforms | all |
