...
sidebar_label: "Detecting Living Off The Land With Lolbas"
description: "Detect Living Off the Land Binaries (LOLBins/LOLBAS) abuse including certutil, regsvr32, mshta, and rundll32 via process telemetry, Sigma rules, and parent-c..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-living-off-the-land-with-lolbas` |
| Path | `optional-skills/cybersecurity/threat-detection/detecting-living-off-the-land-with-lolbas` |
| Platforms | all |
