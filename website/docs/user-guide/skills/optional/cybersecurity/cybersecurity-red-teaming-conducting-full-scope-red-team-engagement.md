...
sidebar_label: "Conducting Full Scope Red Team Engagement"
description: "Plan and execute a comprehensive red team engagement covering reconnaissance through post-exploitation using MITRE ATT&CK-aligned TTPs to evaluate an organiz..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-full-scope-red-team-engagement` |
| Path | `optional-skills/cybersecurity/red-teaming/conducting-full-scope-red-team-engagement` |
| Platforms | all |
