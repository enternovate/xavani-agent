...
sidebar_label: "Implementing Dragos Platform For Ot Monitoring"
description: "Deploy and configure the Dragos Platform for OT network monitoring, leveraging its 600+ industrial protocol parsers, intelligence-driven threat detection ana..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-dragos-platform-for-ot-monitoring` |
| Path | `optional-skills/cybersecurity/ot-ics-security/implementing-dragos-platform-for-ot-monitoring` |
| Platforms | all |
