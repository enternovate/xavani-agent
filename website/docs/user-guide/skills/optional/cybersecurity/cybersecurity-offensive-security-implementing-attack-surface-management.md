...
sidebar_label: "Implementing Attack Surface Management"
description: "Implements external attack surface management (EASM) using Shodan, Censys, and ProjectDiscovery tools (subfinder, httpx, nuclei) for asset discovery, subdoma..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-attack-surface-management` |
| Path | `optional-skills/cybersecurity/offensive-security/implementing-attack-surface-management` |
| Platforms | all |
