...
sidebar_label: "Building Devsecops Pipeline With Gitlab Ci"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-devsecops-pipeline-with-gitlab-ci` |
| Path | `optional-skills/cybersecurity/devsecops/building-devsecops-pipeline-with-gitlab-ci` |
| Platforms | all |
