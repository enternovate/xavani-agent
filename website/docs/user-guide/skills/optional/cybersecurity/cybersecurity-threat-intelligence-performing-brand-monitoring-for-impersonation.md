...
sidebar_label: "Performing Brand Monitoring For Impersonation"
description: "Monitor for brand impersonation attacks across domains, social media, mobile apps, and dark web channels to detect phishing campaigns, fake sites, and unauth..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-brand-monitoring-for-impersonation` |
| Path | `optional-skills/cybersecurity/threat-intelligence/performing-brand-monitoring-for-impersonation` |
| Platforms | all |
