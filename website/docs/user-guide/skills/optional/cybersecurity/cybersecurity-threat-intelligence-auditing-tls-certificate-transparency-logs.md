...
sidebar_label: "Auditing Tls Certificate Transparency Logs"
description: "Monitors Certificate Transparency (CT) logs to detect unauthorized certificate issuance, discover subdomains via CT data, and alert on suspicious certificate..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-tls-certificate-transparency-logs` |
| Path | `optional-skills/cybersecurity/threat-intelligence/auditing-tls-certificate-transparency-logs` |
| Platforms | all |
