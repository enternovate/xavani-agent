...
sidebar_label: "Implementing Devsecops Security Scanning"
description: "Integrates Static Application Security Testing (SAST), Dynamic Application Security Testing (DAST), and Software Composition Analysis (SCA) into CI/CD pipeli..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-devsecops-security-scanning` |
| Path | `optional-skills/cybersecurity/application-security/implementing-devsecops-security-scanning` |
| Platforms | all |
