...
description: "Parses API Gateway access logs (AWS API Gateway, Kong, Nginx) to detect BOLA/IDOR attacks, rate limit bypass, credential scanning, and injection attempts"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-api-gateway-access-logs` |
| Path | `optional-skills/cybersecurity/security-operations/analyzing-api-gateway-access-logs` |
| Platforms | all |
