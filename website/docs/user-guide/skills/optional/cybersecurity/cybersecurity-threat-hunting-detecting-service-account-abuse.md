...
sidebar_label: "Detecting Service Account Abuse"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-service-account-abuse` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-service-account-abuse` |
| Platforms | all |
