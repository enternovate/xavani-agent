...
sidebar_label: "Securing Serverless Functions"
description: "This skill covers security hardening for serverless compute platforms including AWS Lambda, Azure Functions, and Google Cloud Functions"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-serverless-functions` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-serverless-functions` |
| Platforms | all |
