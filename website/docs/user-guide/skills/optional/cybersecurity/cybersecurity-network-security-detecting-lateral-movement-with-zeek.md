---
title: "Detecting Lateral Movement With Zeek — Detect lateral movement in network traffic using Zeek (formerly Bro) log analysis"
sidebar_label: "Detecting Lateral Movement With Zeek"
description: "Detect lateral movement in network traffic using Zeek (formerly Bro) log analysis"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-lateral-movement-with-zeek` |
| Path | `optional-skills/cybersecurity/network-security/detecting-lateral-movement-with-zeek` |
| Platforms | all |
