...
sidebar_label: "Implementing Semgrep For Custom Sast Rules"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-semgrep-for-custom-sast-rules` |
| Path | `optional-skills/cybersecurity/devsecops/implementing-semgrep-for-custom-sast-rules` |
| Platforms | all |
