---
title: "Processing Stix Taxii Feeds — Processes STIX 2"
sidebar_label: "Processing Stix Taxii Feeds"
description: "Processes STIX 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/processing-stix-taxii-feeds` |
| Path | `optional-skills/cybersecurity/threat-intelligence/processing-stix-taxii-feeds` |
| Platforms | all |
