...
sidebar_label: "Securing Azure With Microsoft Defender"
description: "This skill instructs security practitioners on deploying Microsoft Defender for Cloud as a cloud-native application protection platform for Azure, multi-clou..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-azure-with-microsoft-defender` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-azure-with-microsoft-defender` |
| Platforms | all |
