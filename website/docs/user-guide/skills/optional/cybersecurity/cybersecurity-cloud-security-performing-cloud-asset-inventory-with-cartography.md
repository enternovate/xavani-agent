...
sidebar_label: "Performing Cloud Asset Inventory With Cartography"
description: "Perform comprehensive cloud asset inventory and relationship mapping using Cartography to build a Neo4j security graph of infrastructure assets, IAM permissi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-asset-inventory-with-cartography` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-cloud-asset-inventory-with-cartography` |
| Platforms | all |
