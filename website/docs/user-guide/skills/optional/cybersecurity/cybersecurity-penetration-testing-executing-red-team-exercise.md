...
sidebar_label: "Executing Red Team Exercise"
description: "Executes comprehensive red team exercises that simulate real-world adversary operations against an organization's people, processes, and technology"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/executing-red-team-exercise` |
| Path | `optional-skills/cybersecurity/penetration-testing/executing-red-team-exercise` |
| Platforms | all |
