...
sidebar_label: "Recovering Deleted Files With Photorec"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/recovering-deleted-files-with-photorec` |
| Path | `optional-skills/cybersecurity/digital-forensics/recovering-deleted-files-with-photorec` |
| Platforms | all |
