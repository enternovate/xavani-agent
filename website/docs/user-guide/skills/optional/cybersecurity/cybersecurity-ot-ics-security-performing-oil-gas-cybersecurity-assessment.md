...
sidebar_label: "Performing Oil Gas Cybersecurity Assessment"
description: "This skill covers conducting cybersecurity assessments specific to oil and gas facilities including upstream (exploration/production), midstream (pipeline/tr..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-oil-gas-cybersecurity-assessment` |
| Path | `optional-skills/cybersecurity/ot-ics-security/performing-oil-gas-cybersecurity-assessment` |
| Platforms | all |
