...
sidebar_label: "Auditing Gcp Iam Permissions"
description: "Auditing Google Cloud Platform IAM permissions to identify overly permissive bindings, primitive role usage, service account key proliferation, and cross-pro..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-gcp-iam-permissions` |
| Path | `optional-skills/cybersecurity/cloud-security/auditing-gcp-iam-permissions` |
| Platforms | all |
