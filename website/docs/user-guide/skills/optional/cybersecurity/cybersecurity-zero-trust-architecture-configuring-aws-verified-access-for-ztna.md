...
sidebar_label: "Configuring Aws Verified Access For Ztna"
description: "Configure AWS Verified Access to provide VPN-less zero trust network access to internal applications using identity and device posture verification with Ceda..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/configuring-aws-verified-access-for-ztna` |
| Path | `optional-skills/cybersecurity/zero-trust-architecture/configuring-aws-verified-access-for-ztna` |
| Platforms | all |
