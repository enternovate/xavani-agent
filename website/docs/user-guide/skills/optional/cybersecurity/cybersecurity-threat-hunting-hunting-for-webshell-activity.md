...
sidebar_label: "Hunting For Webshell Activity"
description: "Hunt for web shell deployments on internet-facing servers by analyzing file creation in web directories, suspicious process spawning from web servers, and an..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-webshell-activity` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-webshell-activity` |
| Platforms | all |
...
- **d3fend_techniques**: Executable Denylisting, Execution Isolation, File Metadata Consistency Validation, Restore Access, Process Termination
