...
sidebar_label: "Detecting Cryptomining In Cloud"
description: "This skill teaches security teams how to detect and respond to unauthorized cryptocurrency mining operations in cloud environments"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-cryptomining-in-cloud` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-cryptomining-in-cloud` |
| Platforms | all |
