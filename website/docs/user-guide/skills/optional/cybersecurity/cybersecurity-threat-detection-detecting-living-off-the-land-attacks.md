...
sidebar_label: "Detecting Living Off The Land Attacks"
description: "Detect abuse of legitimate Windows binaries (LOLBins) used for living off the land attacks"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-living-off-the-land-attacks` |
| Path | `optional-skills/cybersecurity/threat-detection/detecting-living-off-the-land-attacks` |
| Platforms | all |
