...
description: "Analyze WAF (ModSecurity/AWS WAF/Cloudflare) logs to detect SQL injection attack campaigns"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-sql-injection-via-waf-logs` |
| Path | `optional-skills/cybersecurity/security-operations/detecting-sql-injection-via-waf-logs` |
| Platforms | all |
