...
sidebar_label: "Building Soc Playbook For Ransomware"
description: "Builds a structured SOC incident response playbook for ransomware attacks covering detection, containment, eradication, and recovery phases with specific SIE..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-soc-playbook-for-ransomware` |
| Path | `optional-skills/cybersecurity/soc-operations/building-soc-playbook-for-ransomware` |
| Platforms | all |
