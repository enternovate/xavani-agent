...
sidebar_label: "Performing Privileged Account Access Review"
description: "Conduct systematic reviews of privileged accounts to validate access rights, identify excessive permissions, and enforce least privilege across PAM infrastru..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-privileged-account-access-review` |
| Path | `optional-skills/cybersecurity/identity-access-management/performing-privileged-account-access-review` |
| Platforms | all |
