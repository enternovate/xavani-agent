...
sidebar_label: "Detecting Lateral Movement In Network"
description: "Identifies lateral movement techniques in enterprise networks by analyzing authentication logs, network flows, SMB traffic, and RDP sessions using Zeek, Velo..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-lateral-movement-in-network` |
| Path | `optional-skills/cybersecurity/network-security/detecting-lateral-movement-in-network` |
| Platforms | all |
