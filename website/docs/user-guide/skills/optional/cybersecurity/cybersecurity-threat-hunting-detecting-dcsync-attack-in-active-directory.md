...
sidebar_label: "Detecting Dcsync Attack In Active Directory"
description: "Detect DCSync attacks where adversaries abuse Active Directory replication privileges to extract password hashes by monitoring for non-domain-controller acco..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-dcsync-attack-in-active-directory` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-dcsync-attack-in-active-directory` |
| Platforms | all |
