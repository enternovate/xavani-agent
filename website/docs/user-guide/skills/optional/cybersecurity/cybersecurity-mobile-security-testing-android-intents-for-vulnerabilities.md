...
sidebar_label: "Testing Android Intents For Vulnerabilities"
description: "Tests Android inter-process communication (IPC) through intents for vulnerabilities including intent injection, unauthorized component access, broadcast snif..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-android-intents-for-vulnerabilities` |
| Path | `optional-skills/cybersecurity/mobile-security/testing-android-intents-for-vulnerabilities` |
| Platforms | all |
