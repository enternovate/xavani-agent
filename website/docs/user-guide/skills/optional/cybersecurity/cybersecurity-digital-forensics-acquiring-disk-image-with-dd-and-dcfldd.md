...
sidebar_label: "Acquiring Disk Image With Dd And Dcfldd"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/acquiring-disk-image-with-dd-and-dcfldd` |
| Path | `optional-skills/cybersecurity/digital-forensics/acquiring-disk-image-with-dd-and-dcfldd` |
| Platforms | all |
