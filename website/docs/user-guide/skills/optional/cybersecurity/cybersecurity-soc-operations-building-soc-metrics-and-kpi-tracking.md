...
sidebar_label: "Building Soc Metrics And Kpi Tracking"
description: "Builds SOC performance metrics and KPI tracking dashboards measuring Mean Time to Detect (MTTD), Mean Time to Respond (MTTR), alert quality ratios, analyst p..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-soc-metrics-and-kpi-tracking` |
| Path | `optional-skills/cybersecurity/soc-operations/building-soc-metrics-and-kpi-tracking` |
| Platforms | all |
