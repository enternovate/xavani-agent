...
sidebar_label: "Securing Aws Iam Permissions"
description: "This skill guides practitioners through hardening AWS Identity and Access Management configurations to enforce least privilege access across cloud accounts"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-aws-iam-permissions` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-aws-iam-permissions` |
| Platforms | all |
