...
sidebar_label: "Implementing Policy As Code With Open Policy Agent"
description: "This skill covers implementing Open Policy Agent (OPA) and Gatekeeper for policy-as-code enforcement in Kubernetes and CI/CD pipelines"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-policy-as-code-with-open-policy-agent` |
| Path | `optional-skills/cybersecurity/devsecops/implementing-policy-as-code-with-open-policy-agent` |
| Platforms | all |
