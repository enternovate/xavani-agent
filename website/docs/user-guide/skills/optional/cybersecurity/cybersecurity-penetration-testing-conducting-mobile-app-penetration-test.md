...
sidebar_label: "Conducting Mobile App Penetration Test"
description: "Conducts penetration testing of iOS and Android mobile applications following the OWASP Mobile Application Security Testing Guide (MASTG) to identify vulnera..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-mobile-app-penetration-test` |
| Path | `optional-skills/cybersecurity/penetration-testing/conducting-mobile-app-penetration-test` |
| Platforms | all |
