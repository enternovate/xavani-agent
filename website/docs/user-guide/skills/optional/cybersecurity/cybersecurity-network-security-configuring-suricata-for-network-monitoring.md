...
sidebar_label: "Configuring Suricata For Network Monitoring"
description: "Deploys and configures Suricata IDS/IPS with Emerging Threats rulesets, EVE JSON logging, and custom rules for real-time network traffic inspection, threat d..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/configuring-suricata-for-network-monitoring` |
| Path | `optional-skills/cybersecurity/network-security/configuring-suricata-for-network-monitoring` |
| Platforms | all |
