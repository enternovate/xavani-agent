...
sidebar_label: "Deploying Edr Agent With Crowdstrike"
description: "Deploys and configures CrowdStrike Falcon EDR agents across enterprise endpoints to enable real-time threat detection, behavioral analysis, and automated res..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/deploying-edr-agent-with-crowdstrike` |
| Path | `optional-skills/cybersecurity/endpoint-security/deploying-edr-agent-with-crowdstrike` |
| Platforms | all |
