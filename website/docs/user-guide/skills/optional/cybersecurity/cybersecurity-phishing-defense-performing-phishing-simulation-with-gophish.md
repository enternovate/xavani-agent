...
sidebar_label: "Performing Phishing Simulation With Gophish"
description: "GoPhish is an open-source phishing simulation framework used by security teams to conduct authorized phishing awareness campaigns"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-phishing-simulation-with-gophish` |
| Path | `optional-skills/cybersecurity/phishing-defense/performing-phishing-simulation-with-gophish` |
| Platforms | all |
