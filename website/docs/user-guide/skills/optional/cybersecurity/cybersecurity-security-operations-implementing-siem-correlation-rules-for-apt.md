...
description: "Write multi-event correlation rules that detect APT lateral movement by chaining Windows authentication events, process execution telemetry, and network conn..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-siem-correlation-rules-for-apt` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-siem-correlation-rules-for-apt` |
| Platforms | all |
