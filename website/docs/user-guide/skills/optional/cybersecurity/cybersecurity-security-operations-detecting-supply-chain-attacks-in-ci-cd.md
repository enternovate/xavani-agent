...
description: "Scans GitHub Actions workflows and CI/CD pipeline configurations for supply chain attack vectors including unpinned actions, script injection via expressions..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-supply-chain-attacks-in-ci-cd` |
| Path | `optional-skills/cybersecurity/security-operations/detecting-supply-chain-attacks-in-ci-cd` |
| Platforms | all |
