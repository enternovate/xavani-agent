...
sidebar_label: "Securing Container Registry With Harbor"
description: "Harbor is an open-source container registry that provides security features including vulnerability scanning (integrated Trivy), image signing (Notary/Cosign..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-container-registry-with-harbor` |
| Path | `optional-skills/cybersecurity/container-security/securing-container-registry-with-harbor` |
| Platforms | all |
