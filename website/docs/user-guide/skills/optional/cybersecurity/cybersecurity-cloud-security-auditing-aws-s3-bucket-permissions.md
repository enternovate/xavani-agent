...
sidebar_label: "Auditing Aws S3 Bucket Permissions"
description: "Systematically audit AWS S3 bucket permissions to identify publicly accessible buckets, overly permissive ACLs, misconfigured bucket policies, and missing en..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-aws-s3-bucket-permissions` |
| Path | `optional-skills/cybersecurity/cloud-security/auditing-aws-s3-bucket-permissions` |
| Platforms | all |
