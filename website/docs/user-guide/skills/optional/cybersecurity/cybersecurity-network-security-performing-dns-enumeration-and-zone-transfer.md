...
sidebar_label: "Performing Dns Enumeration And Zone Transfer"
description: "Enumerates DNS records, attempts zone transfers, brute-forces subdomains, and maps DNS infrastructure during authorized reconnaissance to identify attack sur..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-dns-enumeration-and-zone-transfer` |
| Path | `optional-skills/cybersecurity/network-security/performing-dns-enumeration-and-zone-transfer` |
| Platforms | all |
