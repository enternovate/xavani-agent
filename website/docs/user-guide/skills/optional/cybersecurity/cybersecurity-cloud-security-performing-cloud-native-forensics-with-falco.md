...
sidebar_label: "Performing Cloud Native Forensics With Falco"
description: "Uses Falco YAML rules for runtime threat detection in containers and Kubernetes, monitoring syscalls for shell spawns, file tampering, network anomalies, and..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-native-forensics-with-falco` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-cloud-native-forensics-with-falco` |
| Platforms | all |
