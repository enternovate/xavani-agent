...
sidebar_label: "Building Cloud Siem With Sentinel"
description: "This skill covers deploying Microsoft Sentinel as a cloud-native SIEM and SOAR platform for centralized security operations"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-cloud-siem-with-sentinel` |
| Path | `optional-skills/cybersecurity/cloud-security/building-cloud-siem-with-sentinel` |
| Platforms | all |
