...
description: "Detect malicious scheduled task creation and modification using Sysmon Event IDs 1 (Process Create for schtasks"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-malicious-scheduled-tasks-with-sysmon` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-malicious-scheduled-tasks-with-sysmon` |
| Platforms | all |
