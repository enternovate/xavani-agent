...
sidebar_label: "Deploying Osquery For Endpoint Monitoring"
description: "Deploys and configures osquery for real-time endpoint monitoring using SQL-based queries to inspect running processes, open ports, installed software, and sy..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/deploying-osquery-for-endpoint-monitoring` |
| Path | `optional-skills/cybersecurity/endpoint-security/deploying-osquery-for-endpoint-monitoring` |
| Platforms | all |
