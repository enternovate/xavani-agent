...
description: "Perform GCP security testing using GCPBucketBrute for storage bucket enumeration, gcloud IAM privilege escalation path analysis, and service account permissi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-gcp-penetration-testing-with-gcpbucketbrute` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-gcp-penetration-testing-with-gcpbucketbrute` |
| Platforms | all |
