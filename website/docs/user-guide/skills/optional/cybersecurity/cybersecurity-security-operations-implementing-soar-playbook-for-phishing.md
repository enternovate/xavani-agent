...
sidebar_label: "Implementing Soar Playbook For Phishing"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-soar-playbook-for-phishing` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-soar-playbook-for-phishing` |
| Platforms | all |
