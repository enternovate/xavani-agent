...
description: "Detect WMI event subscription persistence by analyzing Sysmon Event IDs 19, 20, and 21 for malicious EventFilter, EventConsumer, and FilterToConsumerBinding ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-wmi-persistence` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-wmi-persistence` |
| Platforms | all |
