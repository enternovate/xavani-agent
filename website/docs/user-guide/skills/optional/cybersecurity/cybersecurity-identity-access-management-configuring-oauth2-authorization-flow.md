---
title: "Configuring Oauth2 Authorization Flow — Configure secure OAuth 2"
sidebar_label: "Configuring Oauth2 Authorization Flow"
description: "Configure secure OAuth 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/configuring-oauth2-authorization-flow` |
| Path | `optional-skills/cybersecurity/identity-access-management/configuring-oauth2-authorization-flow` |
| Platforms | all |
