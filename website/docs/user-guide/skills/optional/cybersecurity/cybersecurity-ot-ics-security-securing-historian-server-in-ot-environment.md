...
sidebar_label: "Securing Historian Server In Ot Environment"
description: "This skill covers hardening and securing process historian servers (OSIsoft PI, Honeywell PHD, GE Proficy, AVEVA Historian) in OT environments"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-historian-server-in-ot-environment` |
| Path | `optional-skills/cybersecurity/ot-ics-security/securing-historian-server-in-ot-environment` |
| Platforms | all |
