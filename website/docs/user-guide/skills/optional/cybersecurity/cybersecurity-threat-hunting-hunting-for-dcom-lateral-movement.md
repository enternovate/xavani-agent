---
title: "Hunting For Dcom Lateral Movement — Hunt for DCOM-based lateral movement by detecting abuse of MMC20"
sidebar_label: "Hunting For Dcom Lateral Movement"
description: "Hunt for DCOM-based lateral movement by detecting abuse of MMC20"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-dcom-lateral-movement` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-dcom-lateral-movement` |
| Platforms | all |
