...
sidebar_label: "Performing Soc Tabletop Exercise"
description: "Performs tabletop exercises for SOC teams simulating security incidents through discussion-based scenarios to test incident response procedures, communicatio..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-soc-tabletop-exercise` |
| Path | `optional-skills/cybersecurity/soc-operations/performing-soc-tabletop-exercise` |
| Platforms | all |
