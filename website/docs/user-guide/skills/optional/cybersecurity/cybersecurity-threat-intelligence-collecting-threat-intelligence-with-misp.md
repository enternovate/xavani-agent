...
sidebar_label: "Collecting Threat Intelligence With Misp"
description: "MISP (Malware Information Sharing Platform) is an open-source threat intelligence platform for gathering, sharing, storing, and correlating Indicators of Com..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/collecting-threat-intelligence-with-misp` |
| Path | `optional-skills/cybersecurity/threat-intelligence/collecting-threat-intelligence-with-misp` |
| Platforms | all |
