...
sidebar_label: "Building Identity Governance Lifecycle Process"
description: "Builds comprehensive identity governance and lifecycle management processes including joiner-mover-leaver automation, role mining, access request workflows, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-identity-governance-lifecycle-process` |
| Path | `optional-skills/cybersecurity/identity-access-management/building-identity-governance-lifecycle-process` |
| Platforms | all |
