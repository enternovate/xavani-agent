...
sidebar_label: "Detecting Stuxnet Style Attacks"
description: "This skill covers detecting sophisticated cyber-physical attacks that follow the Stuxnet attack pattern of modifying PLC logic while spoofing sensor readings..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-stuxnet-style-attacks` |
| Path | `optional-skills/cybersecurity/ot-ics-security/detecting-stuxnet-style-attacks` |
| Platforms | all |
