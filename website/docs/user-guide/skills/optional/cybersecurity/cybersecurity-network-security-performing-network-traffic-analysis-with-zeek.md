...
sidebar_label: "Performing Network Traffic Analysis With Zeek"
description: "Deploy Zeek network security monitor to capture, parse, and analyze network traffic metadata for threat detection, anomaly identification, and forensic inves..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-network-traffic-analysis-with-zeek` |
| Path | `optional-skills/cybersecurity/network-security/performing-network-traffic-analysis-with-zeek` |
| Platforms | all |
