...
sidebar_label: "Implementing Pam For Database Access"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-pam-for-database-access` |
| Path | `optional-skills/cybersecurity/identity-access-management/implementing-pam-for-database-access` |
| Platforms | all |
