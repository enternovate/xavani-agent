...
sidebar_label: "Conducting Spearphishing Simulation Campaign"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-spearphishing-simulation-campaign` |
| Path | `optional-skills/cybersecurity/red-teaming/conducting-spearphishing-simulation-campaign` |
| Platforms | all |
