...
sidebar_label: "Performing Web Cache Deception Attack"
description: "Execute web cache deception attacks by exploiting path normalization discrepancies between CDN caching layers and origin servers to cache and retrieve sensit..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-web-cache-deception-attack` |
| Path | `optional-skills/cybersecurity/web-application-security/performing-web-cache-deception-attack` |
| Platforms | all |
