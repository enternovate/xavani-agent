...
sidebar_label: "Testing Api Authentication Weaknesses"
description: "Tests API authentication mechanisms for weaknesses including broken token validation, missing authentication on endpoints, weak password policies, credential..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-api-authentication-weaknesses` |
| Path | `optional-skills/cybersecurity/api-security/testing-api-authentication-weaknesses` |
| Platforms | all |
