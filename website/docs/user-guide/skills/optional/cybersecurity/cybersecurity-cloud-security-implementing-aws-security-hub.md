...
sidebar_label: "Implementing Aws Security Hub"
description: "This skill covers deploying AWS Security Hub as a centralized cloud security posture management platform that aggregates findings from GuardDuty, Inspector, ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-aws-security-hub` |
| Path | `optional-skills/cybersecurity/cloud-security/implementing-aws-security-hub` |
| Platforms | all |
