...
sidebar_label: "Securing Container Registry Images"
description: "Securing container registry images by implementing vulnerability scanning with Trivy and Grype, enforcing image signing with Cosign and Sigstore, configuring..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/securing-container-registry-images` |
| Path | `optional-skills/cybersecurity/cloud-security/securing-container-registry-images` |
| Platforms | all |
