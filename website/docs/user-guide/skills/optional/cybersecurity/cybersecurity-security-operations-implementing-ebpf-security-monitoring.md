...
sidebar_label: "Implementing Ebpf Security Monitoring"
description: "Implements eBPF-based security monitoring using Cilium Tetragon for real-time process execution tracking, network connection observability, file access audit..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-ebpf-security-monitoring` |
| Path | `optional-skills/cybersecurity/security-operations/implementing-ebpf-security-monitoring` |
| Platforms | all |
