---
title: "Hunting For Dns Tunneling With Zeek — Detect DNS tunneling and data exfiltration by analyzing Zeek dns"
sidebar_label: "Hunting For Dns Tunneling With Zeek"
description: "Detect DNS tunneling and data exfiltration by analyzing Zeek dns"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-dns-tunneling-with-zeek` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-dns-tunneling-with-zeek` |
| Platforms | all |
