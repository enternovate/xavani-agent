...
sidebar_label: "Performing Privacy Impact Assessment"
description: "Automates the Privacy Impact Assessment (PIA) workflow including data flow mapping, privacy risk scoring matrices, GDPR Article 35 DPIA and CCPA/CPRA alignme..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-privacy-impact-assessment` |
| Path | `optional-skills/cybersecurity/privacy-compliance/performing-privacy-impact-assessment` |
| Platforms | all |
