...
sidebar_label: "Containing Active Breach"
description: "Executes containment strategies to stop active adversary operations and prevent lateral movement during a confirmed security breach"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/containing-active-breach` |
| Path | `optional-skills/cybersecurity/incident-response/containing-active-breach` |
| Platforms | all |
