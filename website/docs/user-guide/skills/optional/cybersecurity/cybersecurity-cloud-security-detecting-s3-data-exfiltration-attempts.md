...
sidebar_label: "Detecting S3 Data Exfiltration Attempts"
description: "Detecting data exfiltration attempts from AWS S3 buckets by analyzing CloudTrail S3 data events, VPC Flow Logs, GuardDuty findings, Amazon Macie alerts, and ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-s3-data-exfiltration-attempts` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-s3-data-exfiltration-attempts` |
| Platforms | all |
