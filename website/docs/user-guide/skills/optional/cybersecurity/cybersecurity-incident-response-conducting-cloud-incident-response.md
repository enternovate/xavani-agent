...
sidebar_label: "Conducting Cloud Incident Response"
description: "Responds to security incidents in cloud environments (AWS, Azure, GCP) by performing identity-based containment, cloud-native log analysis, resource isolatio..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/conducting-cloud-incident-response` |
| Path | `optional-skills/cybersecurity/incident-response/conducting-cloud-incident-response` |
| Platforms | all |
