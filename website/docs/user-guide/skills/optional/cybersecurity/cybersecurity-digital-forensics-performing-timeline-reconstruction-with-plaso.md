...
sidebar_label: "Performing Timeline Reconstruction With Plaso"
description: "Build comprehensive forensic super-timelines using Plaso (log2timeline) to correlate events across file systems, logs, and artifacts into a unified chronolog..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-timeline-reconstruction-with-plaso` |
| Path | `optional-skills/cybersecurity/digital-forensics/performing-timeline-reconstruction-with-plaso` |
| Platforms | all |
