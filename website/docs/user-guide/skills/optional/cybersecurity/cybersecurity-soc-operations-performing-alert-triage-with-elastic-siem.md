...
sidebar_label: "Performing Alert Triage With Elastic Siem"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-alert-triage-with-elastic-siem` |
| Path | `optional-skills/cybersecurity/soc-operations/performing-alert-triage-with-elastic-siem` |
| Platforms | all |
