...
sidebar_label: "Implementing Cloud Waf Rules"
description: "This skill covers deploying and tuning Web Application Firewall rules on AWS WAF, Azure WAF, and Cloudflare to protect cloud-hosted applications against OWAS..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-cloud-waf-rules` |
| Path | `optional-skills/cybersecurity/cloud-security/implementing-cloud-waf-rules` |
| Platforms | all |
