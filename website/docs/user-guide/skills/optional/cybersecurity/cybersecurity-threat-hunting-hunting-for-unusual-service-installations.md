---
title: "Hunting For Unusual Service Installations — Detect suspicious Windows service installations (MITRE ATT&CK T1543"
sidebar_label: "Hunting For Unusual Service Installations"
description: "Detect suspicious Windows service installations (MITRE ATT&CK T1543"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-unusual-service-installations` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-unusual-service-installations` |
| Platforms | all |
