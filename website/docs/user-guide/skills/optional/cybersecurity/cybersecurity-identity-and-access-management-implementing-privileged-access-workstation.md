...
description: "Design and implement Privileged Access Workstations (PAWs) with device hardening, just-in-time access, and integration with CyberArk or BeyondTrust for secur..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-privileged-access-workstation` |
| Path | `optional-skills/cybersecurity/identity-and-access-management/implementing-privileged-access-workstation` |
| Platforms | all |
