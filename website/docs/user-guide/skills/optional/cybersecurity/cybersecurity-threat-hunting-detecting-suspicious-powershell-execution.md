...
sidebar_label: "Detecting Suspicious Powershell Execution"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-suspicious-powershell-execution` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-suspicious-powershell-execution` |
| Platforms | all |
