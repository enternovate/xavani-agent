...
sidebar_label: "Performing Cloud Storage Forensic Acquisition"
description: "Perform forensic acquisition and analysis of cloud storage services including Google Drive, OneDrive, Dropbox, and Box by collecting both API-based remote da..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-storage-forensic-acquisition` |
| Path | `optional-skills/cybersecurity/digital-forensics/performing-cloud-storage-forensic-acquisition` |
| Platforms | all |
