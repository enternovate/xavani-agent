...
sidebar_label: "Performing Purple Team Atomic Testing"
description: "Executes Atomic Red Team tests mapped to MITRE ATT&CK techniques, performs coverage gap analysis across the ATT&CK matrix, and runs detection validation loop..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-purple-team-atomic-testing` |
| Path | `optional-skills/cybersecurity/purple-team/performing-purple-team-atomic-testing` |
| Platforms | all |
