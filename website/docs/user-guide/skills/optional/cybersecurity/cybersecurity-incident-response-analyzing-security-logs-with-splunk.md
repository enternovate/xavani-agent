...
sidebar_label: "Analyzing Security Logs With Splunk"
description: "Leverages Splunk Enterprise Security and SPL (Search Processing Language) to investigate security incidents through log correlation, timeline reconstruction,..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-security-logs-with-splunk` |
| Path | `optional-skills/cybersecurity/incident-response/analyzing-security-logs-with-splunk` |
| Platforms | all |
