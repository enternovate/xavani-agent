...
sidebar_label: "Mapping Mitre Attack Techniques"
description: "Maps observed adversary behaviors, security alerts, and detection rules to MITRE ATT&CK techniques and sub-techniques to quantify detection coverage and guid..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/mapping-mitre-attack-techniques` |
| Path | `optional-skills/cybersecurity/threat-intelligence/mapping-mitre-attack-techniques` |
| Platforms | all |
