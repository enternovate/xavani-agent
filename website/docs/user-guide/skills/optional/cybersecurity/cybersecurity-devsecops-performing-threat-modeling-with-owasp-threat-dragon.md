...
sidebar_label: "Performing Threat Modeling With Owasp Threat Dragon"
description: "Use OWASP Threat Dragon to create data flow diagrams, identify threats using STRIDE and LINDDUN methodologies, and generate threat model reports for secure d..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-threat-modeling-with-owasp-threat-dragon` |
| Path | `optional-skills/cybersecurity/devsecops/performing-threat-modeling-with-owasp-threat-dragon` |
| Platforms | all |
