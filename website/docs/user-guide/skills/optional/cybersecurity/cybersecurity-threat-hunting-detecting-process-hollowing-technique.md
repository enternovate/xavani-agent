---
title: "Detecting Process Hollowing Technique — Detect process hollowing (T1055"
sidebar_label: "Detecting Process Hollowing Technique"
description: "Detect process hollowing (T1055"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-process-hollowing-technique` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-process-hollowing-technique` |
| Platforms | all |
...
- **d3fend_techniques**: Platform Monitoring, Process Code Segment Verification, Segment Address Offset Randomization, Process Analysis, Application Hardening
