---
title: "Implementing Google Workspace Sso Configuration — Configure SAML 2"
sidebar_label: "Implementing Google Workspace Sso Configuration"
description: "Configure SAML 2"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-google-workspace-sso-configuration` |
| Path | `optional-skills/cybersecurity/identity-access-management/implementing-google-workspace-sso-configuration` |
| Platforms | all |
