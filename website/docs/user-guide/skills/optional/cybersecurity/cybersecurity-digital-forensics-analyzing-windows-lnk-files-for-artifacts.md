...
sidebar_label: "Analyzing Windows Lnk Files For Artifacts"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-windows-lnk-files-for-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/analyzing-windows-lnk-files-for-artifacts` |
| Platforms | all |
