...
description: "Perform forensic investigation of AWS environments using CloudTrail logs to reconstruct attacker activity, identify compromised credentials, and analyze API ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-cloud-forensics-with-aws-cloudtrail` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-cloud-forensics-with-aws-cloudtrail` |
| Platforms | all |
