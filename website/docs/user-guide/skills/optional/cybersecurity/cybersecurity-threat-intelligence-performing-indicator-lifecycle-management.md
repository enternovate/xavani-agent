...
sidebar_label: "Performing Indicator Lifecycle Management"
description: "Indicator lifecycle management tracks IOCs from initial discovery through validation, enrichment, deployment, monitoring, and eventual retirement"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-indicator-lifecycle-management` |
| Path | `optional-skills/cybersecurity/threat-intelligence/performing-indicator-lifecycle-management` |
| Platforms | all |
