...
description: "Parses Kubernetes API server audit logs (JSON lines) to detect exec-into-pod, secret access, RBAC modifications, privileged pod creation, and anonymous API a..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-kubernetes-audit-logs` |
| Path | `optional-skills/cybersecurity/container-security/analyzing-kubernetes-audit-logs` |
| Platforms | all |
