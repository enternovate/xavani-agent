...
sidebar_label: "Hunting For Persistence Via Wmi Subscriptions"
description: "Hunt for adversary persistence through Windows Management Instrumentation event subscriptions by monitoring WMI consumer, filter, and binding creation events..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/hunting-for-persistence-via-wmi-subscriptions` |
| Path | `optional-skills/cybersecurity/threat-hunting/hunting-for-persistence-via-wmi-subscriptions` |
| Platforms | all |
