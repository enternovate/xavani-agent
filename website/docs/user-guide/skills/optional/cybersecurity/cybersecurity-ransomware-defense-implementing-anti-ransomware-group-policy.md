...
sidebar_label: "Implementing Anti Ransomware Group Policy"
description: "Configures Windows Group Policy Objects (GPO) to prevent ransomware execution and limit its spread"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-anti-ransomware-group-policy` |
| Path | `optional-skills/cybersecurity/ransomware-defense/implementing-anti-ransomware-group-policy` |
| Platforms | all |
