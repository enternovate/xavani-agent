...
sidebar_label: "Detecting Network Anomalies With Zeek"
description: "Deploys and configures Zeek (formerly Bro) network security monitor to passively analyze network traffic, generate structured logs, detect anomalous behavior..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-network-anomalies-with-zeek` |
| Path | `optional-skills/cybersecurity/network-security/detecting-network-anomalies-with-zeek` |
| Platforms | all |
