...
sidebar_label: "Auditing Kubernetes Cluster Rbac"
description: "Auditing Kubernetes cluster RBAC configurations to identify overly permissive roles, wildcard permissions, dangerous ClusterRoleBindings, service account abu..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/auditing-kubernetes-cluster-rbac` |
| Path | `optional-skills/cybersecurity/cloud-security/auditing-kubernetes-cluster-rbac` |
| Platforms | all |
