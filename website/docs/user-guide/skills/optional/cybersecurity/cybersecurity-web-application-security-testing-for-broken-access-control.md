...
sidebar_label: "Testing For Broken Access Control"
description: "Systematically testing web applications for broken access control vulnerabilities including privilege escalation, missing function-level checks, and insecure..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/testing-for-broken-access-control` |
| Path | `optional-skills/cybersecurity/web-application-security/testing-for-broken-access-control` |
| Platforms | all |
