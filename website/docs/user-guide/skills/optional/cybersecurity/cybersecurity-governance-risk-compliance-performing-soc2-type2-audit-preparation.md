...
sidebar_label: "Performing Soc2 Type2 Audit Preparation"
description: "Automates SOC 2 Type II audit preparation including gap assessment against AICPA Trust Services Criteria (CC1-CC9), evidence collection from cloud providers ..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-soc2-type2-audit-preparation` |
| Path | `optional-skills/cybersecurity/governance-risk-compliance/performing-soc2-type2-audit-preparation` |
| Platforms | all |
...
- **nist_csf**: GV.OC-01, GV.RM-01, GV.PO-01, GV.OV-01
- **license**: Apache-2.0
- **author**: mukul975
