...
sidebar_label: "Performing Serverless Function Security Review"
description: "Performing security reviews of serverless functions across AWS Lambda, Azure Functions, and GCP Cloud Functions to identify overly permissive execution roles..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-serverless-function-security-review` |
| Path | `optional-skills/cybersecurity/cloud-security/performing-serverless-function-security-review` |
| Platforms | all |
