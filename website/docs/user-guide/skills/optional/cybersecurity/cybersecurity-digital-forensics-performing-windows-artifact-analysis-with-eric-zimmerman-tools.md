...
sidebar_label: "Performing Windows Artifact Analysis With Eric Zimmerman Tools"
description: "Perform comprehensive Windows forensic artifact analysis using Eric Zimmerman's open-source EZ Tools suite including KAPE, MFTECmd, PECmd, LECmd, JLECmd, and..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-windows-artifact-analysis-with-eric-zimmerman-tools` |
| Path | `optional-skills/cybersecurity/digital-forensics/performing-windows-artifact-analysis-with-eric-zimmerman-tools` |
| Platforms | all |
