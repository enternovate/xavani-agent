...
sidebar_label: "Analyzing Apt Group With Mitre Navigator"
description: "Analyze advanced persistent threat (APT) group techniques using MITRE ATT&CK Navigator to create layered heatmaps of adversary TTPs for detection gap analysi..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/analyzing-apt-group-with-mitre-navigator` |
| Path | `optional-skills/cybersecurity/threat-intelligence/analyzing-apt-group-with-mitre-navigator` |
| Platforms | all |
