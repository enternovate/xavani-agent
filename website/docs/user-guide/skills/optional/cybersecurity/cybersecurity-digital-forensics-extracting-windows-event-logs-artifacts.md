...
sidebar_label: "Extracting Windows Event Logs Artifacts"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/extracting-windows-event-logs-artifacts` |
| Path | `optional-skills/cybersecurity/digital-forensics/extracting-windows-event-logs-artifacts` |
| Platforms | all |
