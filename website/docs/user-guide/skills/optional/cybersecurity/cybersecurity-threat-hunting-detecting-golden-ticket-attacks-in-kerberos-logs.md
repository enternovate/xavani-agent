...
sidebar_label: "Detecting Golden Ticket Attacks In Kerberos Logs"
description: "Detect Golden Ticket attacks in Active Directory by analyzing Kerberos TGT anomalies including mismatched encryption types, impossible ticket lifetimes, non-..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-golden-ticket-attacks-in-kerberos-logs` |
| Path | `optional-skills/cybersecurity/threat-hunting/detecting-golden-ticket-attacks-in-kerberos-logs` |
| Platforms | all |
