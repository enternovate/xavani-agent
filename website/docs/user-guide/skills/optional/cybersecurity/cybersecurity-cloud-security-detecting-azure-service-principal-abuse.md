...
sidebar_label: "Detecting Azure Service Principal Abuse"
description: "Detect and investigate Azure service principal abuse including privilege escalation, credential compromise, admin consent bypass, and unauthorized enumeratio..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/detecting-azure-service-principal-abuse` |
| Path | `optional-skills/cybersecurity/cloud-security/detecting-azure-service-principal-abuse` |
| Platforms | all |
