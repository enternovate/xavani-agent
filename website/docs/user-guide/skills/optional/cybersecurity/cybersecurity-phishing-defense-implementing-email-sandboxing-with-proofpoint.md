...
sidebar_label: "Implementing Email Sandboxing With Proofpoint"
description: "Email sandboxing detonates suspicious attachments and URLs in isolated environments to detect zero-day malware and evasive phishing payloads"
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-email-sandboxing-with-proofpoint` |
| Path | `optional-skills/cybersecurity/phishing-defense/implementing-email-sandboxing-with-proofpoint` |
| Platforms | all |
