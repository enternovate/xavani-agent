...
description: "Scan container images, filesystems, and Kubernetes manifests for vulnerabilities, misconfigurations, exposed secrets, and license compliance issues using Aqu..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-container-security-scanning-with-trivy` |
| Path | `optional-skills/cybersecurity/container-security/performing-container-security-scanning-with-trivy` |
| Platforms | all |
