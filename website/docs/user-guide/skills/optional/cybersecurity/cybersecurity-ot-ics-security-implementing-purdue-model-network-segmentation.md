...
sidebar_label: "Implementing Purdue Model Network Segmentation"
description: "Implement network segmentation based on the Purdue Enterprise Reference Architecture (PERA) model to separate industrial control system networks into hierarc..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/implementing-purdue-model-network-segmentation` |
| Path | `optional-skills/cybersecurity/ot-ics-security/implementing-purdue-model-network-segmentation` |
| Platforms | all |
