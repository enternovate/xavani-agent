...
sidebar_label: "Performing Log Source Onboarding In Siem"
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/performing-log-source-onboarding-in-siem` |
| Path | `optional-skills/cybersecurity/soc-operations/performing-log-source-onboarding-in-siem` |
| Platforms | all |
