...
sidebar_label: "Building Threat Feed Aggregation With Misp"
description: "Deploy MISP (Malware Information Sharing Platform) to aggregate, correlate, and distribute threat intelligence feeds from multiple sources for centralized IO..."
---
...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/cybersecurity/building-threat-feed-aggregation-with-misp` |
| Path | `optional-skills/cybersecurity/threat-intelligence/building-threat-feed-aggregation-with-misp` |
| Platforms | all |
