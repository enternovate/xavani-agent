...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Xavani Agent |
| License | MIT |
...
The script reads `~/.xavani/.env` for two optional defaults:
...
Helper script: `~/.xavani/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.xavani/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.xavani/.env`.
...
```bash
python3 ~/.xavani/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.xavani/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
