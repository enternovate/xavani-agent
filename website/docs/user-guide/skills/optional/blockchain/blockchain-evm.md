...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Xavani Agent |
| License | MIT |
...
Helper script path: `~/.xavani/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.xavani/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.xavani/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.xavani/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
