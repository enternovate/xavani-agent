...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Xavani Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $XAVANI_OSINT_CACHE/icij/ (default: ~/.cache/xavani-osint/icij/).
...
# Set XAVANI_OSINT_UA=your-app/1.0 (your@email) to identify yourself
