...
| | |
|---|---|
| Source | Optional — install with `xavani skills install official/research/qmd` |
...
Xavani Agent via the native MCP client. This is the preferred
...
Then configure Xavani Agent to connect via HTTP:
