...
If you have a paid Xavani Portal subscription, you can use browser automation through the **[Tool Gateway](tool-gateway.md)** without any separate API keys. Run `xavani model` or `xavani tools` to enable it.
:::
