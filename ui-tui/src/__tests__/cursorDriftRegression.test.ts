 ...
 *
 * Symptom: in `xavani --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@xavani/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using xavani --tui and as i type multiline my caret at the end will often ' +
