...
import type { ScrollBoxHandle } from '@xavani/ink'
import { evictInkCaches } from '@xavani/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.XAVANI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
