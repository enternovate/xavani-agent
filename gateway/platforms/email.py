...
"""
Email platform adapter for the Xavani gateway.

Allows users to interact with Xavani by sending emails.
...
def _send_imap_id(imap: "imaplib.IMAP4") -> None:
    ...
    try:
        ...
        imap.xatom(
            ...
            '"vendor" "Enternovate" '
            '"support-email" "noreply@enternovate.co.za")',
        )
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Xavani Agent")
        ...
        msg_id = f"<xavani-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
