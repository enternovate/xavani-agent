...
def _sha1_signature(token: str, timestamp: str, nonce: str, encrypt: str) -> str:
    ...
    # SHA1 is mandated by WeCom's WXBizMsgCrypt callback-signature scheme — it
    # is protocol interop, not Xavani's own security boundary. usedforsecurity
    # marks that for scanners; the digest output is identical.
    return hashlib.sha1(
