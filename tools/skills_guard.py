...
Trust levels:
  - builtin:   Ships with Xavani. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.xavani/\.env|\~/\.xavani/\.env',
     "xavani_env_access", "critical", "exfiltration",
     "directly references Xavani secrets file"),
    ...
    (r'\.xavani/config\.yaml|\.xavani/SOUL\.md',
     "xavani_config_mod", "critical", "persistence",
     "references Xavani configuration files directly"),
