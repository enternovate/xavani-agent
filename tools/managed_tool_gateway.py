...
def auth_json_path():
    """Return the Xavani auth store path, respecting XAVANI_HOME overrides."""
    return get_xavani_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from xavani_cli.auth import resolve_nous_access_token
