...
the get_anchored_view / get_messages_around primitives in xavani_state.
...
# Third-party integrations tag their sessions with XAVANI_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from xavani_state import DEFAULT_DB_PATH
