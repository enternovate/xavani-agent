...
def _profile_user_agent() -> str:
    """Return a ``xavani-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from xavani_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"xavani-cli/{_ver}"
    except Exception:
        return "xavani-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # xavani-cli UA so the catalog endpoint is reachable.
