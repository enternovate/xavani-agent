# Xavani Agent Has Had "Routines" Since March
...
Xavani equivalent — works today:
```bash
xavani webhook subscribe auth-watch \
  --events "pull_request" \
...
Every use case in their blog post — backlog triage, docs drift, deploy verification, alert correlation, library porting, bespoke PR review — has a working Xavani implementation. No new features needed. It's been shipping since March 2026.

---

## What's Different

| | Claude Code Routines | Xavani Agent |
|---|---|---|
...
## Things Xavani Does That Routines Can't
...
Xavani has no daily limit. Run 500 automations a day if you want. The only constraint is your API budget, and you choose which models to use for which tasks.
...
Xavani Agent is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.
...
```bash
xavani gateway setup    # enable webhooks
xavani webhook subscribe pr-review \
  --events "pull_request" \
...
Full automation templates gallery: [xavani-agent.nousresearch.com/docs/guides/automation-templates](https://xavani-agent.nousresearch.com/docs/guides/automation-templates)

Documentation: [xavani-agent.nousresearch.com](https://xavani-agent.nousresearch.com)

GitHub: [github.com/NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)

---

*Xavani Agent is built by [Nous Research](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*
