...
"""Build the Xavani Model Catalog — a centralized JSON manifest of curated models.
...
Xavani CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Xavani release.
...
# Ensure XAVANI_HOME is set for imports that touch it at module level.
os.environ.setdefault("XAVANI_HOME", os.path.join(os.path.expanduser("~"), ".xavani"))

from xavani_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://xavani-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
