...
DEFAULT_DATASETS = [
    ...
    "NousResearch/xavani-agent-megascience-sft1",
    "NousResearch/Xavani-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Xavani-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-xavani-agent"
]
