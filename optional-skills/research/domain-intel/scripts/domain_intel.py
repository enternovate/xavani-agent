...
def check_ssl(host, port=443, timeout=10):
    ...
    try:
        ...
        # Enforce TLS 1.2+ explicitly. Python's create_default_context()
        # historically permitted TLS 1.0 / 1.1 on some interpreter
        # versions; this line guarantees the behaviour regardless of
        # interpreter defaults and silences CodeQL's py/insecure-protocol.
        ...
        # Instead, return the warning without certificate details.
        # The caller can still report the SSL issue without exposing
        # the connection to MITM attacks.
        return {
            "valid": False,
            "warning": warning,
            "issuer": None,
