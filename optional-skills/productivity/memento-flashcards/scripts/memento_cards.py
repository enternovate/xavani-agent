...
Data file: $XAVANI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_XAVANI_HOME = Path(os.environ.get("XAVANI_HOME", Path.home() / ".xavani"))
DATA_DIR = _XAVANI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
