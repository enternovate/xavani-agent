...
Built for [Xavani Agent](https://github.com/enternovate/xavani-agent). Usable in any coding agent. Canonical source lives here; synced to [`enternovate/xavani-agent/skills/creative/ascii-video`](https://github.com/enternovate/xavani-agent/tree/main/skills/creative/ascii-video) via PR.
