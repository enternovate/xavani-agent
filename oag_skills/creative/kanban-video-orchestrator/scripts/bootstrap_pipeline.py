...
def main():
    ...
    Path(args.out).write_text(setup, encoding="utf-8")  # nosec: generated shell script, no credentials
    os.chmod(args.out, 0o755)
    print(f"Wrote {args.out}")

    if args.brief_out:
        Path(args.brief_out).write_text(brief, encoding="utf-8")  # nosec: generated markdown brief, no credentials
