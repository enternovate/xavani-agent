 ...
 * `window.__XAVANI_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Xavani brand in the top bar
 ...
 *  `window.__XAVANI_PLUGINS__.registerSlot(...)`.
 *
