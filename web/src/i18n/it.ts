...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateXavani: "Aggiorna Xavani",
    updatingXavani: "Aggiornamento di Xavani…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Xavani (parità con `xavani plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.xavani/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.xavani/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.xavani/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Xavani da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Xavani in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Xavani di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Xavani rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Xavani sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
