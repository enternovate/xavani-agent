...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateXavani: "Update Xavani",
    updatingXavani: "Updating Xavani…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Xavani plugins (`xavani plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.xavani/plugins/?",
    removeHint: "Only user-installed plugins under ~/.xavani/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.xavani/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Xavani badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Xavani session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Xavani more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Xavani sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Xavani is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
