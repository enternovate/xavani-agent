# Xavani Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.xavani/plugins/xavani-achievements/state.json` (existing unlock state)
  - `~/.xavani/plugins/xavani-achievements/scan_snapshot.json` (new)
  - `~/.xavani/plugins/xavani-achievements/scan_checkpoint.json` (new)
