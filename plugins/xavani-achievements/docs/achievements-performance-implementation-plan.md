# Xavani Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.xavani/plugins/xavani-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.xavani/plugins/xavani-achievements/scan_checkpoint.json`.
