...
``_check_spotify_available()`` — when the user has not run ``xavani auth
spotify``, the tools remain registered (so they appear in ``xavani
...
The Spotify auth flow (``xavani auth spotify``), CLI plumbing, and docs
