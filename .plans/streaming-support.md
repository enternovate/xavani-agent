# Streaming LLM Response Support for Xavani Agent
...
```
XAVANI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("XAVANI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `xavani_cli/config.py` | 1 | +streaming config defaults |
