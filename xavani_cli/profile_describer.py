...
Used by ``xavani profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``xavani_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Xavani Agent kanban board.
...
Rules:
  ...
  - Never write "Xavani Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_xavani_home())
        else:
