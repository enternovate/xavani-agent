...
cookies**. It cannot be a direct OAuth client of the upstream IDP (Xavani
...
from xavani_cli.dashboard_auth.base import Session
...
def register_pending(
    *,
    ...
    upstream PKCE round trip (inside the ``xavani_session_pkce`` cookie), so the
