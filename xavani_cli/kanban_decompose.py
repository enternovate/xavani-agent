...
Invoked by ``xavani kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Xavani Agent board.
...
def _profile_author() -> str:
    """Mirror of ``xavani_cli.kanban._profile_author``."""
    return (
