...
Design notes / invariants (same contract as ``xavani_cli/goals.py``):
...
- This module has zero hard dependency on ``cli.XavaniCLI``, the gateway
...
def _get_session_db() -> Optional[Any]:
    ...
    """
    try:
        from xavani_cli.goals import _get_session_db as _goals_db
