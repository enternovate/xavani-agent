...
"""
Skills configuration for Xavani Agent.
`xavani skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.xavani/config.yaml under:
...
from xavani_cli.config import cfg_get, load_config, save_config
from xavani_cli.colors import Colors, color
from xavani_cli.platforms import PLATFORMS as _PLATFORMS
