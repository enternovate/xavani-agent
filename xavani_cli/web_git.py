...
from xavani_cli._subprocess_compat import harden_git_argv, noninteractive_git_env
...
def worktree_add(cwd: str, options: dict) -> dict:
    ...
    branch = _sanitize_branch(options.get("branch") or "") or f"xavani/{slug}"
