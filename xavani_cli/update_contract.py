...
``xavani update`` mutation (CLI apply, CLI --check, dashboard update
endpoint). The decision layers:

1. **Baked provenance marker** (``/etc/xavani/image-provenance.json``,
   written by the image build — see :mod:`xavani_cli.image_provenance`):
