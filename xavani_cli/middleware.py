"""Xavani middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "xavani.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "xavani.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Xavani sends them.
    """
...
def _invoke_middleware(kind: str, **kwargs: Any) -> List[Any]:
    from xavani_cli.plugins import invoke_middleware
