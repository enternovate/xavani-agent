"""``xavani gateway`` and ``xavani proxy`` subcommand parsers.

Extracted verbatim from ``xavani_cli/main.py:main()`` (god-file Phase 2).
...
from xavani_cli.subcommands._shared import add_accept_hooks_flag
...
def build_gateway_parser(
    ...
    gateway_run.add_argument(
        ...
        help=(
            ...
            "if XAVANI_DASHBOARD is set). Pass --no-supervise to opt out and "
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "Authenticates as your Xavani Portal account (the connector derives the "
            ...
            "GATEWAY_RELAY_SECRET / GATEWAY_RELAY_DELIVERY_KEY into ~/.xavani/.env. "
            "Requires being logged in (xavani setup). Not available in managed installs."
        ),
    )
    ...
    gateway_enroll.add_argument(
        ...
        help=(
            ...
            "GATEWAY_RELAY_WAKE_URL in ~/.xavani/.env and forwarded at provision. "
