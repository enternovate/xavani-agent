"""``xavani debug`` subcommand parser.
...
def build_debug_parser(subparsers, *, cmd_debug: Callable) -> None:
    ...
    debug_parser = subparsers.add_parser(
        ...
        epilog="""\
Examples:
    xavani debug share              Upload debug report (asks for confirmation)
    xavani debug share --yes        Skip confirmation (for scripts/CI)
    ...
    xavani debug share --nous       Upload to Nous-internal storage (private)
