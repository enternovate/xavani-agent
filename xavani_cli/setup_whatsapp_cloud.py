...
Entry point: ``xavani whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``xavani_cli/main.py``).
...
Xavani gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Xavani to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Xavani needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Xavani gateway in another terminal:")
    print("         xavani gateway")
    print()
    ...
    print()
    print("  Docs: https://enternovate.co.za/xavani-agent/docs/user-guide/")
