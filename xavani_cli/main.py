...
OFFICIAL_REPO_URLS = {
    ...
    "git@github.com:NousResearch/xavani-agent.git",
    "https://github.com/NousResearch/hermes-agent",
    "git@github.com:NousResearch/xavani-agent",
}
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from NousResearch/xavani-agent.")
        print()
        try:
            response = (
