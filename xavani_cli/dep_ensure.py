...
def _has_xavani_agent_browser() -> bool:
    ...
    # install.sh installs globally into $XAVANI_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-XavaniHome", str(get_xavani_home()),
        ]
    else:
