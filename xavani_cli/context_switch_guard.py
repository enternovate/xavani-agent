...
so Xavani TUI, CLI, and gateway surfaces that already show switch warnings pick it up.
"""
...
from xavani_cli.model_switch import ModelSwitchResult, resolve_display_context_length
