...
Xavani is exactly the topology this hits: gateway, dispatcher, dashboard,
...
class _TrackingMixin:
    ...
    _xavani_tracked_path: str | None = None

    def close(self) -> None:  # type: ignore[misc]
        with _live_lock:
            path = getattr(self, "_xavani_tracked_path", None)
            ...
            if path is not None:
                self._xavani_tracked_path = None
    ...
    **kwargs,
    ...
    with _live_lock:
        ...
        try:
            ...
            conn._xavani_tracked_path = resolved
