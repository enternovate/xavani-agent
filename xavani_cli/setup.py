...
_DOCS_BASE = "https://xavani-agent.enternovate.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://xavani-agent.enternovate.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://xavani-agent.enternovate.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://xavani-agent.enternovate.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
    print_info("   Open config in your editor:  xavani config edit")
    print_info("   Open config in your editor:  xavani config edit")
