...
(3 SDK retries x 3 Xavani retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_xavani_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".xavani")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Xavani, ...) behind one endpoint.  A 429 can mean either:
