...
"""No-op stub kept after the Xavani Portal provider was removed.

Existing call sites still import these helpers to short-circuit retries when
the upstream provider was rate-limited. Since Xavani no longer ships a Xavani
...
def is_genuine_nous_rate_limit(*_args: Any, **_kwargs: Any) -> bool:
    """No-op stub — Xavani Portal is no longer integrated, so genuine
