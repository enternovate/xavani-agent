...
This adapter lets Xavani use the ``google-gemini-cli`` provider as if it were
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "xavani-agent (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/xavani",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a Xavani issue). Try a different Gemini model or set a "
        ...
        message = (
            ...
            f"retired. Check xavani_cli/models.py for the current list."
        )
    elif err_message:
