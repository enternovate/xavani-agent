...
providers (OpenRouter, Xavani, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Xavani/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Xavani'
    ...
    # is stricter (low/high). Clamp Xavani' wider effort set to what each
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Xavani max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Xavani, OpenRouter,
