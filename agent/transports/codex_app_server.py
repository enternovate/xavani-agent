...
projection into Xavani' display, approval bridging, transcript projection into
...
"codex_app_server"`. Xavani' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("XAVANI_KANBAN_TASK"):
            kanban_db = spawn_env.get("XAVANI_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "XAVANI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("XAVANI_HOME", os.path.expanduser("~/.xavani")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "xavani",
        client_title: str = "Xavani Agent",
