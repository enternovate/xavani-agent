...
```bash
python3 -m pyfiglet "XAVANI" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=XAVANI&font=Slant" | boxes -d stone
```
