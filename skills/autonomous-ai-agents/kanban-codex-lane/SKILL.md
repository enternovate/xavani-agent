...
description: Use when a Xavani Kanban worker wants to run Codex CLI as an isolated implementation lane while Xavani keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Xavani Agent
license: MIT
metadata:
  xavani:
    ...
    related_skills: [kanban-worker, codex, xavani-agent]
---
