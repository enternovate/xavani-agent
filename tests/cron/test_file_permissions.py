...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("xavani_cli.config.get_config_path", return_value=config_path), \
             patch("xavani_cli.config.ensure_xavani_home"):
    ...
    def test_ensure_xavani_home_sets_0700(self):
        home = Path(self.tmpdir) / ".xavani"
        with patch("xavani_cli.config.get_xavani_home", return_value=home):
