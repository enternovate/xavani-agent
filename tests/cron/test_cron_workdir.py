...
class TestRunJobTerminalCwd:
    ...
    def _install_stubs(monkeypatch, observed: dict):
        ...
        # Bypass the real provider resolver — it reads ~/.xavani and credentials.
        from xavani_cli import runtime_provider as _rtp
        monkeypatch.setattr(
            _rtp,
        ...
        # run_job calls load_dotenv(~/.xavani/.env, override=True), which will
