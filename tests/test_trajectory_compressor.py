...
def test_import_loads_env_from_xavani_home(tmp_path, monkeypatch):
    home = tmp_path / ".xavani"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-xavani-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-xavani-home"
