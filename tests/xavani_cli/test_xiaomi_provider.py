...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from xavani_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in XAVANI_OVERLAYS
        overlay = XAVANI_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify xavani doctor recognizes Xiaomi env vars."""
