...
"""Tests for xavani_cli.status model/provider display."""
...
def test_show_status_hides_nous_subscription_section_when_feature_flag_is_off(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("xavani_cli.status.managed_nous_tools_enabled", lambda: False)
    from xavani_cli import status as status_mod
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "xavani_cli.models.probe_lmstudio_models",
