...
"""Tests for the interactive session browser (`xavani sessions browse`).
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """xavani sessions browse should be parseable."""
        from xavani_cli.main import main as _main_entry
