...
"""Tests for MCP tools interactive configuration in xavani_cli.tools_config."""
...
_CHECKLIST = "xavani_cli.curses_ui.curses_checklist"
_SAVE = "xavani_cli.tools_config.save_config"
