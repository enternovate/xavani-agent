...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_xavani_home_override(self, tmp_path):
        """Auth lookup should read from XAVANI_HOME/auth.json, not ~/.xavani/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".xavani").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``xavani tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
