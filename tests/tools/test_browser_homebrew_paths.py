...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/xavani/node_modules/.bin/agent-browser"
        xavani_home = str(tmp_path / "xavani-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
             ...
             patch("xavani_constants.Path.home", return_value=tmp_path), \
