...
class TestTerminalRequirements:
    ...
    def test_terminal_and_execute_code_tools_hide_for_unsupported_vercel_runtime(self, monkeypatch):
        ...
        # Verify check_terminal_requirements returns False with the patches applied.
        # This directly confirms the tool-availability logic without relying on
        # get_tool_definitions' TTL cache which can be stale across xdist workers.
