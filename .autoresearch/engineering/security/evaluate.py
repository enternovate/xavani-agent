...
# --- CONFIGURE THESE ---
TEST_CMD = "cd /Users/andilemushwana/xavani-agent && python3 -m pytest -q --tb=no --no-header tests/xavani_cli/test_tools_config.py tests/xavani_cli/test_doctor.py 2>&1 | tail -3"  # Security-focused tests ~5s
# --- END CONFIG ---
