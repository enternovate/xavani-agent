...
# --- CONFIGURE THESE ---
TEST_CMD = "cd /Users/andilemushwana/xavani-agent && python3 -m pytest -q --tb=no --no-header tests/xavani_cli/ tests/agent/test_deterministic_no_llm.py tests/tools/test_file_sync_perf.py 2>&1 | tail -3"  # Focused test: 4847+ tests in ~60s
# --- END CONFIG ---
